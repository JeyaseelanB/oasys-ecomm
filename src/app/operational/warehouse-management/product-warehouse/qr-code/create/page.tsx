...
export default function CreateQRCodePage() {
  ...
  const varietyStatus = {
    ...
    qrCodeYetToGenerate: searched ? 1 : 0,
  };

  const itemStatus = {
    totalNumberOfItems: searched ? 1 : 0,
    qrCodeGeneratedItems: 0,
    qrCodeToBeGenerated: searched ? 1 : 0,
  };

  const productVarieties: ProductVariety[] = searched
    ? [
        { id: 1, productVarietyCodeName: "ASWS/ANGAVAS SALEM WOVEN SILK PURE SILK", uom: "NOS", dispatchedQuantity: "", receivedQuantity: 10.0, status: "QR_PENDING" },
      ]
    : [];

  const atDetails: ATDetail[] = [
    { id: 1, atNumber: "123", regionType: "", length: 1.83, width: 0.92, endsPerInch: 120, picksPerInch: 100, purchasePrice: null, retailPrice: null },
  ];
  ...
  return (
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Create QR Code</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="mb-6 rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        {/* Form fields */}
        <div className="p-5">
          <div className="grid grid-cols-1 items-end gap-5 md:grid-cols-[1fr_1fr_auto]">
            {/* Society Code / Name */}
            <div>
            ...
            <div className="p-5">
              ...
              <div className="mb-5 grid grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-[#28a745]">10.0</p>
                </div>
              </div>
