...
const MOCK_PRODUCTS: ProductDetail[] = [
  { id: 1, bundleNumber: "BDL-001", barCode: "BC-2024-001", productVarietyCodeName: "ASWS/ANGAVAS SALEM WOVEN SILK PURE SILK", atNumber: "AT-111", rpRate: 8510.00, ppRate: 5000.00, status: "DISPATCHED" },
  { id: 2, bundleNumber: "BDL-001", barCode: "BC-2024-002", productVarietyCodeName: "ASWS/ANGAVAS SALEM WOVEN SILK PURE SILK", atNumber: "AT-112", rpRate: 8510.00, ppRate: 5000.00, status: "DISPATCHED" },
  { id: 3, bundleNumber: "BDL-001", barCode: "BC-2024-003", productVarietyCodeName: "BJR4/BEDSHEET", atNumber: "AT-113", rpRate: 1250.00, ppRate: 800.00, status: "DISPATCHED" },
  { id: 4, bundleNumber: "BDL-002", barCode: "BC-2024-004", productVarietyCodeName: "BJR4/BEDSHEET", atNumber: "AT-114", rpRate: 1250.00, ppRate: 800.00, status: "DISPATCHED" },
  { id: 5, bundleNumber: "BDL-002", barCode: "BC-2024-005", productVarietyCodeName: "PCOT/COTTON SAREE", atNumber: "AT-115", rpRate: 3500.00, ppRate: 2200.00, status: "DISPATCHED" },
];

const MOCK_BUNDLES: BundleDetail[] = [
  { id: 1, bundleNumber: "BDL-001", totalItems: 3, totalRPValue: 18270.00, totalPPValue: 10800.00 },
  { id: 2, bundleNumber: "BDL-002", totalItems: 2, totalRPValue: 4750.00, totalPPValue: 3000.00 },
];

const MOCK_INWARD_DETAILS: InwardDetail[] = [
  { id: 1, atNumber: "AT-111", regionType: "INNER_STATE", length: 1.83, width: 0.92, endsPerInch: 120, picksPerInch: 100, purchasePrice: 5000, retailPrice: 8510 },
  { id: 2, atNumber: "AT-112", regionType: "INNER_STATE", length: 1.83, width: 0.92, endsPerInch: 120, picksPerInch: 100, purchasePrice: 5000, retailPrice: 8510 },
];
        ...
        <div className="rounded-t-[10px] bg-[#FFA70B] px-5 py-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-6 text-sm text-white">
              <div><span className="font-semibold">Stock Outward #:</span> 2026-362484</div>
              <div><span className="font-semibold">Movement Type:</span> Warehouse</div>
        ...
        <div className="p-5">
          ...
          <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="rounded border border-stroke p-4 dark:border-dark-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div><p className="text-xs text-gray-500">Sender Code / Name</p><p className="text-sm font-medium text-dark dark:text-white">2381/PWH CHENNIMALAI</p></div>
                <div><p className="text-xs text-gray-500">Address</p><p className="text-sm font-medium text-dark dark:text-white">15&17 PATEL STREET, INGUR ROAD, CHENNIMALAI, NAMAKKAL, TAMIL NADU - 637001</p></div>
              </div>
            </div>
            <div className="rounded border border-stroke p-4 dark:border-dark-3">
              <h4 className="mb-3 flex items-center gap-2 text-sm font-semibold text-dark dark:text-white">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div><p className="text-xs text-gray-500">Receiver Code / Name</p><p className="text-sm font-medium text-dark dark:text-white">1185/DWH - COIMBATORE</p></div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div><p className="mb-1 text-xs text-gray-500">Transport Name</p><p className="text-sm font-medium text-dark dark:text-white">SRI MURUGAN TRANSPORT</p></div>
              <div><p className="mb-1 text-xs text-gray-500">Vehicle Number</p><p className="text-sm font-medium text-dark dark:text-white">TN 33 AB 1234</p></div>
              <div><p className="mb-1 text-xs text-gray-500">Driver Name</p><p className="text-sm font-medium text-dark dark:text-white">MURUGAN</p></div>
              <div><p className="mb-1 text-xs text-gray-500">Driver Phone</p><p className="text-sm font-medium text-dark dark:text-white">9876543210</p></div>
              <div className="md:col-span-2 lg:col-span-4"><p className="mb-1 text-xs text-gray-500">Remarks</p><p className="text-sm font-medium text-dark dark:text-white">Handle with care - Silk products</p></div>
            </div>
          </div>

          {/* Action Buttons */}
          <div className="flex items-center justify-end gap-3 border-t border-stroke pt-4 dark:border-dark-3">
            <button onClick={() => router.push("/operational/warehouse-management/product-warehouse/stock-outward/list")} className="rounded bg-[#6c757d] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90">Back</button>
            <Link href="/operational/warehouse-management/product-warehouse/stock-outward/delivery-challan" className="rounded bg-[#007bff] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90">Delivery Challan</Link>
            <Link href="/operational/warehouse-management/product-warehouse/stock-outward/pp-delivery-challan" className="rounded bg-[#6f42c1] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90">PP Delivery Challan</Link>
          </div>
        </div>
      </div>
