...
/* ─────────────────────────── Types ─────────────────────────── */
type OutwardStatus = "SUBMITTED" | "CANCELLED";
type AcknowledgeStatus = "ACKNOWLEDGED" | "AWAITING ACKNOWLEDGEMENT";
...
const ACK_DATA: Record<number, AckDetails> = {
  1: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2024-353102", stockOutwardDate: "18-Jan-2024", receiverEntityCodeName: "1650 / TVPM-EGMORE", stockInwardNumber: "1650-2024-355207", stockInwardDate: "30-Jan-2024" },
  2: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-324984", stockOutwardDate: "19-Sep-2023", receiverEntityCodeName: "1650 / TVPM-EGMORE", stockInwardNumber: "1650-2023-325100", stockInwardDate: "22-Sep-2023" },
  3: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-300602", stockOutwardDate: "02-Jun-2023", receiverEntityCodeName: "1653 / EXPORT VARIETY", stockInwardNumber: "1653-2023-300700", stockInwardDate: "05-Jun-2023" },
  4: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-290396", stockOutwardDate: "12-Apr-2023", receiverEntityCodeName: "1633 / HOME TEX - T.NAGAR", stockInwardNumber: "1633-2023-290500", stockInwardDate: "15-Apr-2023" },
  5: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-290168", stockOutwardDate: "10-Apr-2023", receiverEntityCodeName: "1633 / HOME TEX - T.NAGAR", stockInwardNumber: "1633-2023-290200", stockInwardDate: "12-Apr-2023" },
  6: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-290161", stockOutwardDate: "10-Apr-2023", receiverEntityCodeName: "1633 / HOME TEX - T.NAGAR", stockInwardNumber: "1633-2023-290190", stockInwardDate: "12-Apr-2023" },
  7: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-290120", stockOutwardDate: "10-Apr-2023", receiverEntityCodeName: "1633 / HOME TEX - T.NAGAR", stockInwardNumber: "1633-2023-290150", stockInwardDate: "12-Apr-2023" },
  8: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2023-274138-MOVED", stockOutwardDate: "31-Mar-2018", receiverEntityCodeName: "1653 / EXPORT VARIETY", stockInwardNumber: "", stockInwardDate: "" },
  9: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2022-262437", stockOutwardDate: "11-Nov-2022", receiverEntityCodeName: "5243 / BALA-NEW DELHI", stockInwardNumber: "5243-2022-262500", stockInwardDate: "15-Nov-2022" },
  10: { senderEntityCodeName: "2281 / COOPTEX INTERNATIONAL", stockOutwardNumber: "2022-252248", stockOutwardDate: "10-Oct-2022", receiverEntityCodeName: "1650 / TVPM-EGMORE", stockInwardNumber: "1650-2022-252300", stockInwardDate: "13-Oct-2022" },
};
...
const SAMPLE_DATA: StockOutward[] = [
  { id: 1, stockInwardNumber: "2024-353102", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1650 / TVPM-EGMORE", transferredDate: "18-Jan-2024", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 2, stockInwardNumber: "2023-324984", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1650 / TVPM-EGMORE", transferredDate: "19-Sep-2023", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 3, stockInwardNumber: "2023-300602", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1653 / EXPORT VARIETY", transferredDate: "02-Jun-2023", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 4, stockInwardNumber: "2023-290396", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1633 / HOME TEX - T.NAGAR", transferredDate: "12-Apr-2023", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 5, stockInwardNumber: "2023-290168", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1633 / HOME TEX - T.NAGAR", transferredDate: "10-Apr-2023", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 6, stockInwardNumber: "2023-290161", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1633 / HOME TEX - T.NAGAR", transferredDate: "10-Apr-2023", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 7, stockInwardNumber: "2023-290120", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1633 / HOME TEX - T.NAGAR", transferredDate: "10-Apr-2023", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 8, stockInwardNumber: "2023-274138-MOVED", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1653 / EXPORT VARIETY", transferredDate: "31-Mar-2018", status: "CANCELLED", acknowledgeStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 9, stockInwardNumber: "2022-262437", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "5243 / BALA-NEW DELHI", transferredDate: "11-Nov-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 10, stockInwardNumber: "2022-252248", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1650 / TVPM-EGMORE", transferredDate: "10-Oct-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 11, stockInwardNumber: "2022-250100", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1633 / HOME TEX - T.NAGAR", transferredDate: "01-Oct-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 12, stockInwardNumber: "2022-248500", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1652 / READYMADE ORGANIC", transferredDate: "15-Sep-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 13, stockInwardNumber: "2022-245200", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1650 / TVPM-EGMORE", transferredDate: "01-Sep-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 14, stockInwardNumber: "2022-242800", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1663 / BUTTERFLY - EGMORE", transferredDate: "15-Aug-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
  { id: 15, stockInwardNumber: "2022-240100", senderCodeName: "2281 / COOPTEX INTERNATIONAL", receiverCodeName: "1653 / EXPORT VARIETY", transferredDate: "01-Aug-2022", status: "SUBMITTED", acknowledgeStatus: "ACKNOWLEDGED" },
];
...
const ACK_STATUS_STYLES: Record<AcknowledgeStatus, string> = {
  ...
  "AWAITING ACKNOWLEDGEMENT": "bg-[#FFA70B] text-white",
};
...
/* ═══════════════════════════════════════════════════════════════
   PAGE
═══════════════════════════════════════════════════════════════ */
export default function ExportWarehouseStockOutwardListPage() {
    ...
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          Stock Outward List - Export Warehouse
        </h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Stock Outward List - Export Warehouse</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              onClick={() => {
                if (selectedId !== null) {
                  router.push("/operational/warehouse-management/export-warehouse/stock-outward/delivery-challan");
                }
              }}
            ...
            <Link href="/operational/warehouse-management/export-warehouse/stock-outward/create">
            ...
            <button
              ...
              onClick={() => {
                if (selectedId !== null) {
                  router.push("/operational/warehouse-management/export-warehouse/stock-outward/view");
                }
              }}
            ...
            <button
              disabled={selectedId === null}
              className="flex items-center gap-1.5 rounded bg-[#dc3545] px-3.5 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="relative z-10 w-full max-w-4xl rounded-lg bg-white shadow-2xl dark:bg-gray-dark">
              ...
              <div className="p-6">
                ...
                <div className="mb-5 flex justify-end">
                  <span className={`rounded border-2 px-3 py-1 text-sm font-bold ${ackModalRow.acknowledgeStatus === "ACKNOWLEDGED" ? "border-[#28a745] text-[#28a745]" : "border-[#FFA70B] text-[#FFA70B]"}`}>{ackModalRow.acknowledgeStatus}</span>
                </div>
