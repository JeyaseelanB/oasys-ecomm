...
/* ─────────────────────────── Sample Data ─────────────────────────── */
const challanData = {
  challanNumber: "2023-347699",
  date: "22-Dec-2023",
  from: {
    unitName: "ISSR - COIMBATORE",
    unitCode: "1176",
    address: "NO.201-A DR.ALAGESAN ROAD SAIBABA MISSION POST - 641 011",
    gstin: "33AAAAH2788P1Z8",
  },
  to: {
    unitName: "R.S.PURAM",
    unitCode: "1115",
    address: "NO.6 GANESHMAHAL DIWAN BAHADUR ROAD - 641 002",
    gstin: "33AAAAH2788P1Z8",
  },
};

const transferorProducts: TransferorProduct[] = [
  { id: 1, productCode: "DBB4", hsnCode: "63041940", productName: "DEPARTMENT BEDSHEET", rpRateRs: 530, rpRateP: "00", noOfUnits: 10.0, rpValueRs: 5300, rpValueP: "00" },
];
...
const hsnSummary: HsnSummary[] = [
  { id: 1, hsnCode: "63041940", noOfUnits: 10.0, rpValue: 5300.0 },
];

const productSummary: ProductSummary[] = [
  { id: 1, productCode: "DBB4", noOfUnits: 10.0, rpValue: 5300.0 },
];

const transferorTotal = { noOfUnits: 10.0, rpValueRs: 5300.0 };
const transfereeTotal = { noOfUnits: 10.0, rpValueRs: 5300.0 };
