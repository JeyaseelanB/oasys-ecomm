...
const SAMPLE_DATA: StockOutwardItem[] = [
  { id: 1, stockInwardNumber: "2026-362501", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1242/NAGAPATTINAM", transferredDate: "08-Mar-2026", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 2, stockInwardNumber: "2026-362498", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1811/ATTUR", transferredDate: "07-Mar-2026", status: "INITIATED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 3, stockInwardNumber: "2026-362495", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1827/THANGAM PATTU MALIGAI", transferredDate: "06-Mar-2026", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
  { id: 4, stockInwardNumber: "2026-362492", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1676/ISSR - CHENNAI", transferredDate: "05-Mar-2026", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 5, stockInwardNumber: "2026-362489", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1350/ERODE", transferredDate: "04-Mar-2026", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
  { id: 6, stockInwardNumber: "2026-362486", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "2085/DWH-TIRUNELVELI", transferredDate: "03-Mar-2026", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 7, stockInwardNumber: "2026-362483", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1540/POLLACHI", transferredDate: "02-Mar-2026", status: "INITIATED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 8, stockInwardNumber: "2026-362480", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1976/ISSR - THANJAVUR", transferredDate: "01-Mar-2026", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
  { id: 9, stockInwardNumber: "2026-362477", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1430/TIRUPUR", transferredDate: "28-Feb-2026", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 10, stockInwardNumber: "2026-362474", senderCodeName: "2105/IC - VELLORE", receiverCodeName: "1827/THANGAM PATTU MALIGAI", transferredDate: "27-Feb-2026", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
];
...
export default function ICStockOutwardListPage() {
  const router = useRouter();
  const [filters, setFilters] = useState({ stockInwardNumber: "", senderCodeName: "", receiverCodeName: "", transferredDate: "", status: "", ackStatus: "" });
  ...
  const handleClear = () => { setFilters({ stockInwardNumber: "", senderCodeName: "", receiverCodeName: "", transferredDate: "", status: "", ackStatus: "" }); setSelectedId(null); setCurrentPage(1); };
  ...
  const basePath = "/operational/warehouse-management/inspection-center/stock-outward";

  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Stock Outward List - Inspection Center</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Stock Outward List - Inspection Center</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">0</span> - Stock Outward List(s)</p>
          <div className="flex flex-wrap items-center gap-2">
            <button disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#6c757d] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
            ...
            <button onClick={() => { if (selectedId) router.push(`${basePath}/list`); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
            ...
            <button disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#dc3545] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th className="cursor-pointer border border-[#3aa88f] px-2 py-3 text-center align-middle font-semibold hover:bg-[#267a68]" onClick={() => handleSort("transferredDate")}>Transferred Date <SortIcon col="transferredDate" /></th>
              ...
              {paginated.length === 0 ? (<tr><td colSpan={8} className="py-8 text-center text-gray-400">No records found</td></tr>) : (
                paginated.map((row, idx) => (
                  <tr key={row.id} className={`border-b border-stroke dark:border-dark-3 ${idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"} hover:bg-blue-50 dark:hover:bg-[#1e2d42]`}>
                    ...
                    <td className="border-r border-stroke px-2 py-3 text-center align-middle text-dark dark:border-dark-3 dark:text-white">{row.transferredDate}</td>
                    ...
                    <td className="border-r border-stroke px-2 py-3 text-center align-middle dark:border-dark-3"><span className={`inline-flex items-center justify-center rounded-sm px-2 py-0.5 text-xs font-semibold ${ACK_STYLES[row.ackStatus]}`}>{row.ackStatus}</span></td>
