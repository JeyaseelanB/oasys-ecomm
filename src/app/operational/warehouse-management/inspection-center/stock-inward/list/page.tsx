...
type StockStatus = "SUBMITTED" | "PENDING" | "RECEIVED";
...
const SAMPLE_DATA: StockInwardItem[] = [
  { id: 1, stockInwardNumber: "2026-370101", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "08-Mar-2026", status: "SUBMITTED" },
  { id: 2, stockInwardNumber: "2026-370098", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "07-Mar-2026", status: "RECEIVED" },
  { id: 3, stockInwardNumber: "2026-370095", senderCodeName: "2181/PWH-KANCHIPURAM", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "06-Mar-2026", status: "SUBMITTED" },
  { id: 4, stockInwardNumber: "2026-370090", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "05-Mar-2026", status: "PENDING" },
  { id: 5, stockInwardNumber: "2026-370085", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "04-Mar-2026", status: "SUBMITTED" },
  { id: 6, stockInwardNumber: "2026-370080", senderCodeName: "2181/PWH-KANCHIPURAM", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "03-Mar-2026", status: "RECEIVED" },
  { id: 7, stockInwardNumber: "2026-370075", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "02-Mar-2026", status: "SUBMITTED" },
  { id: 8, stockInwardNumber: "2026-370070", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "01-Mar-2026", status: "PENDING" },
  { id: 9, stockInwardNumber: "2026-370065", senderCodeName: "2181/PWH-KANCHIPURAM", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "28-Feb-2026", status: "SUBMITTED" },
  { id: 10, stockInwardNumber: "2026-370060", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "2105/IC - VELLORE", stockReceivedDate: "27-Feb-2026", status: "RECEIVED" },
];

const STATUS_STYLES: Record<StockStatus, string> = { SUBMITTED: "bg-[#FFA70B] text-white", PENDING: "bg-[#17a2b8] text-white", RECEIVED: "bg-[#28a745] text-white" };

type SortKey = keyof StockInwardItem;
type SortDir = "asc" | "desc";
const PAGE_SIZE_OPTIONS = [10, 25, 50, 100];

export default function ICStockInwardListPage() {
  ...
  const basePath = "/operational/warehouse-management/inspection-center/stock-inward";

  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Stock Inward List - Inspection Center</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">List Stock Inward - Inspection Center</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">0</span> - List Stock Inward - Inspection Center (s)</p>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button onClick={() => { if (selectedId) setShowEditAlert(true); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#28a745] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
            ...
            <button onClick={() => { if (selectedId) router.push(`${basePath}/list`); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th className="cursor-pointer border border-[#3aa88f] px-2 py-3 text-center align-middle font-semibold hover:bg-[#267a68]" onClick={() => handleSort("stockReceivedDate")}>Stock Received Date <SortIcon col="stockReceivedDate" /></th>
              ...
              <tr className="bg-white dark:bg-gray-dark">
                ...
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"><select className="w-full rounded border border-stroke bg-transparent px-1 py-1 text-xs outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" value={filters.status} onChange={(e) => { setFilters((f) => ({ ...f, status: e.target.value })); setCurrentPage(1); }}><option value="">Select</option><option value="SUBMITTED">SUBMITTED</option><option value="PENDING">PENDING</option><option value="RECEIVED">RECEIVED</option></select></td>
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"></td>
              </tr>
            </thead>
            <tbody>
