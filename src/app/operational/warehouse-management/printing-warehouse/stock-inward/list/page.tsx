...
const SAMPLE_DATA: StockInward[] = [
  { id: 1, stockInwardNumber: "2023-310861", senderCodeName: "711102 / ArunaTextileProcessingMills", receiverCodeName: "1381 / Printing Warehouse (Erotex Dye Factory Godown) - Erode", stockReceivedDate: "27-Jul-2023", status: "SUBMITTED" },
  { id: 2, stockInwardNumber: "2023-310860", senderCodeName: "131950 / KUNNAGAMPONDIPUDUR WCS. C.1372", receiverCodeName: "1381 / Printing Warehouse (Erotex Dye Factory Godown) - Erode", stockReceivedDate: "27-Jul-2023", status: "SUBMITTED" },
];
...
/* ═══════════════════════════════════════════════════════════════
   PAGE
═══════════════════════════════════════════════════════════════ */
export default function PrintingWarehouseStockInwardListPage() {
    ...
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          Stock Inward List - Printing Warehouse
        </h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Stock Inward List - Printing Warehouse</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> &nbsp;- Stock Inward(s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/operational/warehouse-management/printing-warehouse/stock-inward/create">
            ...
            <button
              ...
              onClick={() => {
                if (selectedId !== null) {
                  router.push("/operational/warehouse-management/printing-warehouse/stock-inward/view");
                }
              }}
