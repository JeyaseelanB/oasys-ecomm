...
export default function DWAcknowledgementReportPage() {
  ...
  const reportInfo = {
    societyCodeName: "1185 / DWH - COIMBATORE",
    invoiceNumber: "INV-2026-101",
    invoiceDate: "04-Mar-2026",
    inwardReferenceNumber: "1185-MAR26-362490",
            ...
            <div>
              ...
              <div className="flex">
                ...
                <select value={invoiceNumberDate} onChange={(e) => setInvoiceNumberDate(e.target.value)} className="w-full rounded-r border border-stroke bg-transparent px-3 py-2 text-sm outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white">
                  ...
                  <option value="INV-2026-101 / 04-Mar-2026">INV-2026-101 / 04-Mar-2026</option>
                  <option value="INV-2024-4502 / 08-Mar-2024">INV-2024-4502 / 08-Mar-2024</option>
                </select>
              </div>
            </div>
          </div>
