...
export default function CreateProcurementCostingPage() {
  ...
  // Yarn Details
  const [warpWastage, setWarpWastage] = useState("0.00");
  const [weftWastage, setWeftWastage] = useState("0.00");
  const [warpYarnRate, setWarpYarnRate] = useState("0.00");
  const [weftYarnRate, setWeftYarnRate] = useState("0.00");
  const [numberOfUnits, setNumberOfUnits] = useState("0.00");
  const [weightPerUnit, setWeightPerUnit] = useState("0.00");
  const [warpYarnGms, setWarpYarnGms] = useState("0.00");
  const [weftYarnGms, setWeftYarnGms] = useState("0.00");

  // Cost Details
  const [weavingWages, setWeavingWages] = useState("0.00");
  const [preparatoryCharges, setPreparatoryCharges] = useState("0.00");
  const [profitPercentage, setProfitPercentage] = useState("0");
  const [labelCharge, setLabelCharge] = useState("0.00");
  const [finishingCharge, setFinishingCharge] = useState("0.00");
  const [boxCharge, setBoxCharge] = useState("0.00");
  const [polythinCoverCharge, setPolythinCoverCharge] = useState("0.00");
  const [printingCharge, setPrintingCharge] = useState("0.00");
  const [coverCharge, setCoverCharge] = useState("0.00");
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Create Procurement Costing</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Create Procurement Costing</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="p-5">
          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Product Length (Meters)", value: prodLength, set: setProdLength, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="3" y1="21" x2="21" y2="3"/><path d="M8 8l4-4M16 16l4-4"/></svg> },
                { label: "Product Width (Meters)", value: prodWidth, set: setProdWidth, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="3" y1="12" x2="21" y2="12"/><polyline points="8,7 3,12 8,17"/><polyline points="16,7 21,12 16,17"/></svg> },
                { label: "Warp Yarn Count", value: warpYarnCount, set: setWarpYarnCount, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> },
                { label: "Weft Yarn Count", value: weftYarnCount, set: setWeftYarnCount, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> },
                { label: "Warp Yarn Quality", value: warpYarnQuality, set: setWarpYarnQuality, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> },
                { label: "Weft Yarn Quality", value: weftYarnQuality, set: setWeftYarnQuality, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> },
                { label: "Warp Yarn Weight (in gms)", value: warpYarnWeight, set: setWarpYarnWeight, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 2a3 3 0 013 3v1h4l1 16H4L5 6h4V5a3 3 0 013-3z"/></svg> },
                { label: "Weft Yarn Weight (in gms)", value: weftYarnWeight, set: setWeftYarnWeight, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 2a3 3 0 013 3v1h4l1 16H4L5 6h4V5a3 3 0 013-3z"/></svg> },
                { label: "Hank Yarn Weight", value: hankYarnWeight, set: setHankYarnWeight, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="22,12 18,12 15,21 9,3 6,12 2,12"/></svg> },
                { label: "Ends Per Inch", value: endsPerInch, set: setEndsPerInch, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="22,12 18,12 15,21 9,3 6,12 2,12"/></svg> },
                { label: "Picks Per Inch", value: picksPerInch, set: setPicksPerInch, icon: <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="22,12 18,12 15,21 9,3 6,12 2,12"/></svg> },
          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Warp Wastage (%)", value: warpWastage, set: setWarpWastage, isPercent: true },
                { label: "Weft Wastage (%)", value: weftWastage, set: setWeftWastage, isPercent: true },
                { label: "Warp Yarn Rate", value: warpYarnRate, set: setWarpYarnRate, isPercent: false },
                { label: "Weft Yarn Rate", value: weftYarnRate, set: setWeftYarnRate, isPercent: false },
                { label: "Number of Units", value: numberOfUnits, set: setNumberOfUnits, isPercent: false, isHash: true },
                { label: "Weight Per Unit", value: weightPerUnit, set: setWeightPerUnit, isPercent: false },
                { label: "Warp Yarn (in gms)", value: warpYarnGms, set: setWarpYarnGms, isPercent: false, isWeight: true },
                { label: "Weft Yarn (in gms)", value: weftYarnGms, set: setWeftYarnGms, isPercent: false, isWeight: true },
              ].map(({ label, value, set, isPercent, isHash, isWeight }) => (
                <div key={label}>
                  ...
                  <div className="flex">
                    <IconBox>
                      {isPercent ? (
                        ...
                        <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 2a3 3 0 013 3v1h4l1 16H4L5 6h4V5a3 3 0 013-3z"/></svg>
                      ) : (
                        <span className="text-sm font-bold">₹</span>
                      )}
                    </IconBox>
          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              {/* Calculated readonly */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Warp Yarn</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{warpYarnCost.toFixed(2)}</div></div>
              </div>
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Weft Yarn</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{weftYarnCost.toFixed(2)}</div></div>
              </div>
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Warp Wastage Amount</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{warpWastageAmt.toFixed(2)}</div></div>
              </div>
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Weft Wastage Amount</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{weftWastageAmt.toFixed(2)}</div></div>
              </div>
              ...
              {[
                ...
                <div key={label}>
                  <label className="mb-1 block text-xs font-medium text-dark dark:text-white">{label} <span className="text-red-500">*</span></label>
                  <div className="flex"><RupeeIcon /><input type="text" value={value} onChange={(e) => set(e.target.value)} className={numInputCls} /></div>
                </div>
              ))}
              ...
              {/* Total Rate readonly */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Total Rate</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{totalRate.toFixed(2)}</div></div>
              </div>

              {/* Rate Per Unit readonly */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Rate Per Unit</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{ratePerUnit.toFixed(2)}</div></div>
              </div>
              ...
              {/* Total Purchase Price readonly */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-500">Total Purchase Price</label>
                <div className="flex"><RupeeIcon /><div className={roNumInputCls}>{totalPurchasePrice.toFixed(2)}</div></div>
              </div>
            </div>
            ...
            <div className="mt-5">
              <div className="flex flex-wrap items-end gap-4">
                ...
                <div>
                  ...
                  <div className="flex">
                    <RupeeIcon />
                    <input type="text" value={otherChargeAmount} onChange={(e) => setOtherChargeAmount(e.target.value)} className="w-36 rounded-r border border-stroke bg-transparent px-3 py-2 text-right text-sm outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                  </div>
                </div>
                ...
                <table className="w-full border-collapse text-sm">
                  ...
                  <tbody>
                    {otherCharges.length === 0 ? (
                      <tr><td colSpan={4} className="py-4 text-center text-gray-400 text-xs">No records found</td></tr>
                    ) : (
          ...
          <div className="w-full max-w-3xl rounded-[10px] bg-white shadow-xl dark:bg-gray-dark">
            ...
            <div className="p-5">
              ...
              <div className="mb-2 flex flex-wrap items-center gap-1 rounded border border-stroke bg-gray-50 px-3 py-2 dark:border-dark-3 dark:bg-dark-2">
                {["B", "I", "U", "S"].map((f) => (
                  <button key={f} className="flex size-6 items-center justify-center rounded text-xs font-bold text-gray-600 hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-dark-3">{f}</button>
                ))}
                <div className="mx-1 h-4 w-px bg-gray-300"></div>
                {["H1", "H2", '""', "<>"].map((f) => (
                  <button key={f} className="flex h-6 items-center rounded px-1 text-xs font-medium text-gray-600 hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-dark-3">{f}</button>
                ))}
                <div className="mx-1 h-4 w-px bg-gray-300"></div>
                {["≡", "≡", "🔗", "⊞"].map((f, i) => (
                  <button key={i} className="flex h-6 items-center rounded px-1 text-xs text-gray-600 hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-dark-3">{f}</button>
                ))}
              </div>
              {/* Editor */}
              <textarea
