...
type TenderStatus = "ACTIVE" | "INACTIVE";
...
const SAMPLE_DATA: TenderItem[] = [
  { id: 1, tenderName: "Trial Tender", tenderReferenceNumber: "12345", tenderType: "Open Tender", tenderCategory: "Printing and Publishing", bidOpeningDate: "28-Nov-2022", bidClosingDate: "30-Nov-2022", status: "ACTIVE" },
  { id: 2, tenderName: "Building", tenderReferenceNumber: "123", tenderType: "Closed Tender", tenderCategory: "Paper and Packaging", bidOpeningDate: "04-Nov-2022", bidClosingDate: "30-Nov-2022", status: "ACTIVE" },
];
...
export default function TenderListPage() {
  ...
  const basePath = "/operational/tender/create-tender";

  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Tender List</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Tender List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">{filtered.length}</span> - Tender(s)</p>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button onClick={() => { if (selectedId) router.push(`${basePath}/edit`); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#28a745] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
