...
// Time field with up/down arrows
...
export default function CreateTextileLibraryPage() {
  ...
  const [bookReturnDate, setBookReturnDate] = useState("");
    ...
    <div className="p-4">
      <nav className="mb-1 text-sm text-gray-500">
        <ol className="flex flex-wrap items-center gap-1">
          ...
          <li>/</li>
          <li className="text-gray-700">Create Textile Library Register</li>
        </ol>
      </nav>
      <h1 className="text-base font-semibold text-gray-800 mb-3">Create Textile Library Register</h1>
