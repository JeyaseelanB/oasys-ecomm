...
const LINE_ITEMS: EmpViewItem[] = [
  { id: 1, pfNumber: "3268", name: "SATHISH T.V",   designation: "MANAGER GRADE – II",  payscale: "5200 - 20200", incrementPercentage: 3.00, existingBasicPay: 27420, incrementAmount: 830,  revisedBasicPay: 28250, financialBenefitFrom: "02-Mar-2025", effectiveDate: "17-Mar-2025" },
  { id: 2, pfNumber: "3177", name: "KARUNANITHI P", designation: "MANAGER GRADE – III", payscale: "5200 - 20200", incrementPercentage: 3.00, existingBasicPay: 28620, incrementAmount: 860,  revisedBasicPay: 29480, financialBenefitFrom: "01-Apr-2025", effectiveDate: "01-Apr-2025" },
  { id: 3, pfNumber: "3546", name: "PREETHA S",     designation: "PRODUCTION SUPERVISOR(EXPORT)", payscale: "6550 - 20200", incrementPercentage: 3.00, existingBasicPay: 23330, incrementAmount: 700,  revisedBasicPay: 24030, financialBenefitFrom: "01-Apr-2025", effectiveDate: "01-Apr-2025" },
];

const NOTES: NoteEntry[] = [
  {
    id: 1,
    html: "Increment approved for all eligible employees as per annual increment policy.",
    cards: [
      { title: "Created By", name: "ADMIN USER", designation: "HR MANAGER", date: "10-03-2025" },
      { title: "Final Approved By", name: "GM HR", designation: "GENERAL MANAGER", date: "15-03-2025" },
    ],
  },
  {
    id: 2,
    html: "All employee records verified and increment amounts calculated based on performance ratings.",
    cards: [
      { title: "Created By", name: "HR MANAGER", designation: "MANAGER", date: "12-03-2025" },
    ],
  },
];

export default function IncrementViewPage() {
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">View Increment</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark">
        ...
        <div className="p-6">
          ...
          <div className="mb-4 grid grid-cols-2 gap-x-8">
            ...
            <p className="text-xs text-gray-500">Increment Cycle</p>
            <p className="text-sm font-semibold text-[#17b8c8]">CHENNAI</p>
            <p className="text-sm font-semibold text-[#17b8c8]">July</p>
          </div>
            ...
            <table className="w-full border-collapse text-sm min-w-[1000px]">
              <thead>
                <tr className="bg-[#2d8f7b] text-white">
                  ...
                  <th className="border border-[#3aa88f] px-3 py-2 text-center font-semibold whitespace-nowrap">Increment Percentage</th>
                  ...
                  <th className="border border-[#3aa88f] px-3 py-2 text-center font-semibold whitespace-nowrap">Financial Benefit From</th>
                ...
                {LINE_ITEMS.length === 0 ? (
                  ...
                  LINE_ITEMS.map((item, idx) => (
                    <tr key={item.id}
                      ...
                      <td className="border-r border-stroke px-3 py-2 text-dark dark:border-dark-3 dark:text-white whitespace-nowrap">{item.pfNumber} / {item.name}</td>
                      <td className="border-r border-stroke px-3 py-2 text-dark dark:border-dark-3 dark:text-white">{item.designation}</td>
                      <td className="border-r border-stroke px-3 py-2 text-dark dark:border-dark-3 dark:text-white whitespace-nowrap">{item.payscale}</td>
                      <td className="border-r border-stroke px-3 py-2 text-right text-dark dark:border-dark-3 dark:text-white">{item.incrementPercentage.toFixed(2)}</td>
                      <td className="border-r border-stroke px-3 py-2 text-right text-dark dark:border-dark-3 dark:text-white">{item.existingBasicPay.toFixed(2)}</td>
                      <td className="border-r border-stroke px-3 py-2 text-right text-dark dark:border-dark-3 dark:text-white">{item.incrementAmount.toFixed(2)}</td>
                      <td className="border-r border-stroke px-3 py-2 text-right text-dark dark:border-dark-3 dark:text-white">{item.revisedBasicPay.toFixed(2)}</td>
                      <td className="border-r border-stroke px-3 py-2 text-center text-dark dark:border-dark-3 dark:text-white whitespace-nowrap">{item.financialBenefitFrom}</td>
                      <td className="px-3 py-2 text-center text-dark dark:text-white whitespace-nowrap">{item.effectiveDate}</td>
                    </tr>
                  ))
                )}
              </tbody>
