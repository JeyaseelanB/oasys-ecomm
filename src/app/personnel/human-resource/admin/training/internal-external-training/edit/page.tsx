...
export default function EditInternalExternalTrainingPage() {
  const router = useRouter();
  const [showNoteModal, setShowNoteModal] = useState(false);

  const [trainingType, setTrainingType] = useState("INTERNAL");
  const [reason, setReason] = useState("Training for improving internal process knowledge and team collaboration.");
  const [fileName, setFileName] = useState("training_doc.pdf");
  ...
  return (
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Edit Internal / External Training Request</h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Edit Internal / External Training Request</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="p-5">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            {/* File Upload */}
            <div className="md:col-span-2">
              <div className="mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Uploaded Document</div>
              <div className="mb-2 flex items-center gap-2">
                <span className="text-sm text-[#17a2b8]">{fileName}</span>
              </div>
