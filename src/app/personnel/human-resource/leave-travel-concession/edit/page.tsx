...
export default function EditLeaveTravelConcessionPage() {
  ...
  const dates = [
    { sNo: 1, fromDate: "18-Nov-2024", toDate: "20-Nov-2024", noOfDays: 3 },
    { sNo: 2, fromDate: "25-Nov-2024", toDate: "26-Nov-2024", noOfDays: 2 },
  ];

  const noteCards = [
    { title: "Created By", name: "174 / LAVANYA M", designation: "JUNIOR ASSISTANT", date: "07-10-2024" },
  ];

  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Edit Leave Travel Concession</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            <li><Link href="/" className="font-medium text-dark hover:text-primary dark:text-gray-400">Home</Link></li>
            <li className="text-gray-400">/</li><li className="text-gray-500 dark:text-gray-400">Personnel</li>
            <li className="text-gray-400">/</li><li className="text-gray-500 dark:text-gray-400">Human Resource</li>
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Edit Leave Travel Concession</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="p-5">
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="SALEM" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="Distribution Warehouse" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="DWH - SALEM" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="MARKETING" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="GENERAL" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="174 / LAVANYA M" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="2024-2027" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <input type="text" defaultValue="500" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="flex items-center">
                <input type="date" defaultValue="2024-11-18" className="w-full rounded-l border border-r-0 border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
            ...
            <div>
              ...
              <div className="flex items-center">
                <input type="date" defaultValue="2024-11-26" className="w-full rounded-l border border-r-0 border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
                <span className="inline-flex items-center rounded-r border border-l-0 border-stroke px-3 py-2.5 text-white" style={{ backgroundColor: "#17a2b8" }}>
                  <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                </span>
              </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <input type="text" readOnly defaultValue="5" className="w-full rounded-r border border-stroke bg-gray-50 px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center">
                ...
                <input type="text" defaultValue="450" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="Train" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="Sleeper Class" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <select defaultValue="Earned Leave" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                  <option value="">Select</option>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="flex items-center">
                ...
                <input type="text" readOnly defaultValue="15" className="w-full rounded-r border border-stroke bg-gray-50 px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
              </div>
            </div>
            <div>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="flex items-center">
                ...
                <input type="text" defaultValue="1500" className="w-full rounded-r border border-stroke px-3 py-2.5 text-sm dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 border-t border-stroke pt-4 dark:border-dark-3">
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-auto">
                ...
                <tbody>
                  {dates.map((d) => (
                    <tr key={d.sNo} className="hover:bg-gray-50 dark:hover:bg-dark-2">
                      <td className="border border-stroke px-3 py-2 text-sm text-dark dark:border-dark-3 dark:text-white">{d.sNo}</td>
                      <td className="border border-stroke px-3 py-2 text-sm text-dark dark:border-dark-3 dark:text-white">{d.fromDate}</td>
                      <td className="border border-stroke px-3 py-2 text-sm text-dark dark:border-dark-3 dark:text-white">{d.toDate}</td>
                      <td className="border border-stroke px-3 py-2 text-sm text-dark dark:border-dark-3 dark:text-white">{d.noOfDays}</td>
                      <td className="border border-stroke px-3 py-2 dark:border-dark-3">
                        <button className="text-[#dc3545] hover:opacity-80">
