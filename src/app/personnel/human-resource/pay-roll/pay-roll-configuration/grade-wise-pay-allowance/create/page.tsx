...
export default function CreateGradeWisePayAllowancePage() {
  ...
  const PrefixInput = ({ prefix, value, onChange, error, placeholder = "", type = "number" }: {
    prefix: string; value: string; onChange: (v: string) => void; error?: string; placeholder?: string; type?: string;
  }) => (
  ...
  const IconSelect = ({ icon, value, onChange, options, error }: {
    ...
    <div className={`flex items-center overflow-hidden rounded border ${error ? "border-red-400" : "border-stroke dark:border-dark-3"} bg-white dark:bg-gray-dark`}>
      <span className="flex w-9 items-center justify-center border-r border-stroke bg-gray-100 py-2 text-gray-500 dark:border-dark-3 dark:bg-gray-700">
        {icon}
      </span>
    ...
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          Create Grade Wise Pay Allowance
        </h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Create Grade Wise Pay Allowance</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="p-5 space-y-4">
          {/* Row 1: Pay Range From / Pay Range To / Allowance City Grade / Amount */}
          ...
          {/* Row 2: Employee Type / With Effect From / Status */}
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div>
