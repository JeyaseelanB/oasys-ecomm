...
export default function CreateOTRegisterPage() {
  const router = useRouter();
  const [form, setForm] = useState<Record<FormField, string>>({
    hoRo: "", entityType: "", entity: "", department: "",
    section: "", year: "", month: "", status: "",
  });
  ...
  const IconSelect = ({ icon, field, options, required }: { icon: React.ReactNode; field: FormField; options: string[]; required?: boolean }) => (
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Create OT Register</h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Create OT Register</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <IconSelect icon={<BuildingIcon />} field="hoRo" options={HO_RO_OPTIONS} required />
              {errors.hoRo && <p className={errCls}>{errors.hoRo}</p>}
            </div>
            <div>
              <label className={labelCls}>Entity Type <span className="text-red-500">*</span></label>
              <IconSelect icon={<ListIcon />} field="entityType" options={ENTITY_TYPE_OPTIONS} required />
            ...
            <div>
              ...
              <IconSelect icon={<BuildingIcon />} field="entity" options={ENTITY_OPTIONS} required />
            ...
            <div>
              ...
              <IconSelect icon={<OrgIcon />} field="department" options={DEPT_OPTIONS} required />
              {errors.department && <p className={errCls}>{errors.department}</p>}
            </div>
          </div>

          {/* Row 2: Section / Year / Month / Status */}
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div>
            ...
            <div>
              ...
              <IconSelect icon={<CalendarIcon />} field="year" options={YEAR_OPTIONS} required />
            ...
            <div>
              ...
              <IconSelect icon={<DocIcon />} field="status" options={STATUS_OPTIONS} required />
