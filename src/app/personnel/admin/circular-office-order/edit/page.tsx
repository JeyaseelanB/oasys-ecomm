...
const INITIAL: Record<FormField, string> = {
  type: "Circular", circularFor: "All Staff", hoRo: "Head Office",
  entityTypeCode: "HO", entityCode: "Head Office", department: "ADMIN", section: "Admin",
  meetingType: "Board Meeting", meetingVenue: "Conference Hall A",
  meetingDate: "2024-01-15", startTime: "10:00", endTime: "12:00",
  reminderMail: "1 Day Before", initiatedBy: "Admin Officer", meetingSection: "Admin",
  meetingRequired: "Yes", subject: "Annual Policy Update – All Staff",
  forwardTo: "Director", forwardFor: "Approval",
};
...
export default function EditCircularOfficeOrderPage() {
  const router = useRouter();
  const fileRef = useRef<HTMLInputElement>(null);
  const [form, setForm] = useState<Record<FormField, string>>(INITIAL);
  const [errors, setErrors] = useState<Record<string, string>>({});
  const [uploadFileName, setUploadFileName] = useState("circular_2024_001.pdf");
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Edit Circular / Office Order</h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Edit Circular / Office Order</li>
          </ol>
        </nav>
      </div>
            ...
            <div>
              ...
              <div className="rounded border border-stroke dark:border-dark-3">
                ...
                <div contentEditable suppressContentEditableWarning
                  ...
                  This circular is to inform all staff members about the upcoming policy changes effective from the new financial year. Please review and acknowledge receipt.
                </div>
              </div>
            </div>
          </div>
