...
export default function CreateSupplyRateConfirmationPage() {
    ...
    <div className="mx-auto space-y-5">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          Retail Sales - Create Supply Rate Confirmation - Society
        </h2>
        <nav><ol className="flex items-center gap-1.5 text-sm">
          ...
          <li className="text-gray-400">/</li>
          <li className="font-medium text-primary">Retail Sales - Create Supply Rate Confirmation - Society</li>
        </ol></nav>
      </div>
      ...
      <div className="overflow-hidden rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              <tr><td colSpan={10} className="py-4 text-left px-3 text-sm text-dark dark:text-white">No records found.</td></tr>
            </tbody>
          </table>
        </div>
        <div className="flex justify-end border-t border-stroke px-5 py-3 dark:border-dark-3">
          <span className="text-sm font-medium text-dark dark:text-white">
            ...
            <span className="inline-block min-w-[100px] rounded border border-stroke bg-gray-50 px-3 py-1 text-sm dark:border-dark-3 dark:bg-dark-2"></span>
          </span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 p-5 lg:grid-cols-3">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody>
                <tr><td colSpan={6} className="py-3 text-left px-3 text-sm text-dark dark:text-white">No records found.</td></tr>
                <tr className="bg-[#f0f0f0] dark:bg-dark-2">
                  <td colSpan={6} className="border-t border-stroke px-3 py-2 text-center text-sm font-semibold dark:border-dark-3">Total</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea rows={6} className="w-full resize-none rounded border border-stroke bg-transparent px-3 py-2 text-sm text-dark outline-none focus:border-[#17a2b8] dark:border-dark-3 dark:text-white"/>
          </div>
          {/* Right panel */}
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <tbody>
                <tr><td className="py-3 text-left text-sm text-dark dark:text-white">No records found</td></tr>
                <tr className="bg-[#f0f0f0] dark:bg-dark-2">
                  <td className="border-t border-stroke px-3 py-2 text-center text-sm font-semibold dark:border-dark-3">Total</td>
                </tr>
              </tbody>
            </table>
          </div>
