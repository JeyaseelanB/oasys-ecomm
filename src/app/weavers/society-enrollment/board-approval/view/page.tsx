...
const VISIT_DATE = "06-Jun-2022";

const NOTES = [
  { id: 1, text: "Board approval note", status: "SUBMITTED", name: "SANKARANARAYANAN C", designation: "SUPERINTENDENT", date: "06-Jun-2022" },
];
...
export default function BoardApprovalViewPage() {
  ...
  return (
    <div className="mx-auto space-y-5">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">View Board Approval</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">View Board Approval</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark">
        ...
        <div className="flex items-center justify-between border-t border-stroke px-5 py-4 dark:border-dark-3">
          ...
          <button onClick={() => router.push("/weavers/society-enrollment/board-approval/list")} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90">
          ...
          <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl dark:bg-gray-dark">
            ...
            <div className="p-4">
              ...
              <div className="mt-3 w-72 rounded border border-orange-300 p-3 text-xs text-dark dark:text-white">
                <p className="mb-1.5 text-center font-semibold">{NOTES[noteIndex]?.status}</p>
