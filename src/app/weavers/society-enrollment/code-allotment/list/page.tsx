...
type CodeAllotmentStatus = "CODE_ALLOTTED";

interface CodeAllotment {
  id: number;
  societyName: string;
  ...
  dateOfVisit: string;
  createdDate: string;
  status: CodeAllotmentStatus;
}

const SAMPLE_DATA: CodeAllotment[] = [
  { id: 1, societyName: "muru", societyRegistrationNumber: "4466464", societyRegistrationDate: "21-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 2, societyName: "tessfgsg", societyRegistrationNumber: "GSSGGS", societyRegistrationDate: "15-Feb-2025", dateOfVisit: "15-Feb-2025", createdDate: "21-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 3, societyName: "ging", societyRegistrationNumber: "757755", societyRegistrationDate: "21-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 4, societyName: "gingg", societyRegistrationNumber: "4664", societyRegistrationDate: "21-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 5, societyName: "harshath", societyRegistrationNumber: "23456", societyRegistrationDate: "15-Feb-2025", dateOfVisit: "15-Feb-2025", createdDate: "20-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 6, societyName: "New Testing", societyRegistrationNumber: "550550", societyRegistrationDate: "31-Jul-2024", dateOfVisit: "14-Feb-2025", createdDate: "20-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 7, societyName: "Pondy", societyRegistrationNumber: "5757757575", societyRegistrationDate: "13-Feb-2025", dateOfVisit: "13-Feb-2025", createdDate: "20-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 8, societyName: "RRRR", societyRegistrationNumber: "235665432", societyRegistrationDate: "14-Feb-2025", dateOfVisit: "14-Feb-2025", createdDate: "20-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 9, societyName: "arun", societyRegistrationNumber: "12345876", societyRegistrationDate: "13-Feb-2025", dateOfVisit: "14-Feb-2025", createdDate: "20-Feb-2025", status: "CODE_ALLOTTED" },
  { id: 10, societyName: "ringa", societyRegistrationNumber: "2829824989", societyRegistrationDate: "12-Feb-2025", dateOfVisit: "19-Feb-2025", createdDate: "20-Feb-2025", status: "CODE_ALLOTTED" },
];

const STATUS_STYLES: Record<CodeAllotmentStatus, string> = {
  CODE_ALLOTTED: "bg-[#17a2b8] text-white",
};

type SortKey = keyof CodeAllotment;
type SortDir = "asc" | "desc";
const PAGE_SIZE_OPTIONS = [10, 25, 50, 100];

export default function CodeAllotmentListPage() {
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Code Allotment List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> &nbsp;- Code Allotment(s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/weavers/society-enrollment/code-allotment/add">
            ...
            <button
              ...
              onClick={() => selectedId !== null && router.push("/weavers/society-enrollment/code-allotment/view")}
            >
              ...
              <tr className="bg-white dark:bg-gray-dark">
                ...
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3">
                  <select className="w-full rounded border border-stroke bg-transparent px-2 py-1 text-xs text-dark outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" value={filters.status} onChange={(e) => { setFilters((f) => ({ ...f, status: e.target.value })); setCurrentPage(1); }}>
                    ...
                    <option value="CODE_ALLOTTED">CODE_ALLOTTED</option>
                  </select>
                </td>
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3" />
              </tr>
