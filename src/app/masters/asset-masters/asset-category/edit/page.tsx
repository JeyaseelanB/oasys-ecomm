...
export default function EditAssetCategoryPage() {
  ...
  const [form, setForm] = useState({ parentAssetCategory: "Wood", assetCategoryName: "Forum", assetCategoryNameTamil: "Sisham", assetCategoryCode: "SASA", status: "Active" });
  const handleChange = (field: string, value: string) => setForm((f) => ({ ...f, [field]: value }));

  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Edit Asset Category</h2>
        <nav><ol className="flex items-center gap-1.5 text-sm"><li><Link href="/" className="font-medium text-dark hover:text-primary dark:text-gray-400">Home</Link></li><li className="text-gray-400">/</li><li className="text-gray-500 dark:text-gray-400">Masters</li><li className="text-gray-400">/</li><li className="text-gray-500 dark:text-gray-400">Asset Masters</li><li className="text-gray-400">/</li><li className="font-medium text-primary">Edit Asset Category</li></ol></nav>
      </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div>
              ...
              <div className="flex items-center overflow-hidden rounded border border-stroke dark:border-dark-3">
                ...
                <input type="text" className="w-full bg-transparent px-3 py-2.5 text-sm outline-none dark:text-white" value={form.assetCategoryName} onChange={(e) => handleChange("assetCategoryName", e.target.value)} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center overflow-hidden rounded border border-stroke dark:border-dark-3">
                <IconBox><svg className="size-4 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/><path d="M8 12l2-6 2 6M9 10h2"/></svg></IconBox>
                <input type="text" className="w-full bg-transparent px-3 py-2.5 text-sm outline-none dark:text-white" value={form.assetCategoryNameTamil} onChange={(e) => handleChange("assetCategoryNameTamil", e.target.value)} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center overflow-hidden rounded border border-stroke dark:border-dark-3">
                ...
                <input type="text" className="w-full bg-transparent px-3 py-2.5 text-sm outline-none dark:text-white" value={form.assetCategoryCode} onChange={(e) => handleChange("assetCategoryCode", e.target.value)} />
              </div>
            </div>
          </div>
