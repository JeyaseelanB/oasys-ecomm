...
export default function CreateSocietyProductAppraiserPage() {
  const router = useRouter();
  const [form, setForm] = useState({
    productCategory: "", productGroup: "", productVariety: "",
    weaverName: "", weaverIdNumber: "", appraisedBy: "", societyAtNumber: "",
    appraiserQuantity: "0.0", rawMaterialIssueDate: "",
    ...
    picksPerInch: "", productCost: "", warpYarnType: "", weftYarnType: "",
  });
  ...
  return (
    <div className="mx-auto space-y-5">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Create Society Product Appraiser</h2>
        <nav><ol className="flex items-center gap-1.5 text-sm">
          ...
          <li className="text-gray-400">/</li>
          <li className="font-medium text-primary">Create Society Product Appraiser</li>
        </ol></nav>
      </div>
        ...
        <div className="space-y-6 p-5">
          ...
          <div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <FieldGroup label="Border Type" icon={<ListIcon/>}>
