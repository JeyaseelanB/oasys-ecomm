...
const SAMPLE_DATA: FieldVerification[] = [
  { id: 1, societyName: "muru", societyRegistrationNumber: "4466464", societyRegistrationDate: "21-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025" },
  { id: 2, societyName: "gingg", societyRegistrationNumber: "4664", societyRegistrationDate: "21-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025" },
  { id: 3, societyName: "tedsaddd", societyRegistrationNumber: "757", societyRegistrationDate: "14-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025" },
  { id: 4, societyName: "ging", societyRegistrationNumber: "757755", societyRegistrationDate: "21-Feb-2025", dateOfVisit: "21-Feb-2025", createdDate: "21-Feb-2025" },
  { id: 5, societyName: "ringa", societyRegistrationNumber: "2829824989", societyRegistrationDate: "12-Feb-2025", dateOfVisit: "19-Feb-2025", createdDate: "19-Feb-2025" },
  { id: 6, societyName: "tessfgsg", societyRegistrationNumber: "GSSGGS", societyRegistrationDate: "15-Feb-2025", dateOfVisit: "15-Feb-2025", createdDate: "15-Feb-2025" },
  { id: 7, societyName: "harshath", societyRegistrationNumber: "23456", societyRegistrationDate: "15-Feb-2025", dateOfVisit: "15-Feb-2025", createdDate: "15-Feb-2025" },
  { id: 8, societyName: "vicky", societyRegistrationNumber: "1234567", societyRegistrationDate: "14-Feb-2025", dateOfVisit: "14-Feb-2025", createdDate: "14-Feb-2025" },
  { id: 9, societyName: "RRRR", societyRegistrationNumber: "235665432", societyRegistrationDate: "14-Feb-2025", dateOfVisit: "14-Feb-2025", createdDate: "14-Feb-2025" },
  { id: 10, societyName: "New Testing", societyRegistrationNumber: "550550", societyRegistrationDate: "31-Jul-2024", dateOfVisit: "14-Feb-2025", createdDate: "14-Feb-2025" },
];

type SortKey = keyof FieldVerification;
type SortDir = "asc" | "desc";
const PAGE_SIZE_OPTIONS = [10, 25, 50, 100];

export default function FieldVerificationListPage() {
  ...
  const handleClear = () => {
    setFilters({ societyName: "", societyRegistrationNumber: "", societyRegistrationDate: "", dateOfVisit: "", createdDate: "" });
    setSelectedId(null);
    setCurrentPage(1);
  };
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Field Verification List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> &nbsp;- Field Verification(s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/weavers/society-enrollment/field-verification/add">
            ...
            <button
              ...
              onClick={() => selectedId !== null && router.push("/weavers/society-enrollment/field-verification/view")}
            >
            ...
            <button
              disabled={selectedId === null}
              className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-3 py-1.5 text-sm font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
              onClick={() => selectedId !== null && router.push("/weavers/society-enrollment/field-verification/edit")}
            >
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                {(["societyName", "societyRegistrationNumber", "societyRegistrationDate", "dateOfVisit", "createdDate"] as SortKey[]).map((col, i) => (
                  <th key={col} className="cursor-pointer border border-[#3aa88f] px-3 py-3 text-center font-semibold hover:bg-[#267a68]" onClick={() => handleSort(col)}>
                    {["Society Name", "Society Registration Number", "Society Registration Date", "Date of Visit to the Society", "Created Date"][i]}
                    <SortIcon col={col} />
                  </th>
                ))}
