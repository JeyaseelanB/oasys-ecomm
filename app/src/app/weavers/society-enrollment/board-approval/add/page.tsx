...
const LOOM_VERIFICATION = [
  { memberName: "jklm", memberAddress: "plo street, azq nag.......", industryAddress: "xyz, India, SALEM, .......", numberOfLooms: "1.0", rationCard: "", aadhaar: "648090875678" },
];
...
/* ═══════════════════════════════════════════════════════════════ */
export default function BoardApprovalAddPage() {
  ...
  return (
    <div className="mx-auto space-y-5">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Create Board Approval</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Create Board Approval</li>
          </ol>
        </nav>
      </div>
            ...
            {societyDetails && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-x-6 gap-y-3 lg:grid-cols-4">
                  ...
                  <div><p className={lblCls}>Recommendation Letter Received From</p>
          ...
          <>
              ...
              <div className="flex cursor-pointer items-center justify-between bg-[#17a2b8] px-5 py-3" onClick={() => setDocsOpen((o) => !o)}>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 text-xs">
                    <span className="rounded-full bg-[#17a2b8] border border-white px-2 py-0.5 font-semibold text-white">Total Files <span className="ml-1 rounded-full bg-white px-1.5 text-[#17a2b8]">12</span></span>
                    ...
                    <tbody>
                      {SUPPORTING_DOCS.map((doc, idx) => (
                        <tr key={idx} className={idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-gray-50 dark:bg-[#1a2232]"}>
                          ...
                          <td className="border-b border-r border-stroke px-3 py-2 text-xs text-gray-500 dark:border-dark-3">/fileserver/INFOTEX-FILES/OPERATION/SOCIETY/ENROLLMENT/uploaded/Helpdesk_Module_Implementation.docx</td>
            ...
            <div className="flex items-center justify-between border-t border-stroke px-5 py-4 dark:border-dark-3">
              ...
              <div className="flex gap-2">
                <button onClick={() => router.push("/weavers/society-enrollment/board-approval/list")} className="flex items-center gap-1.5 rounded bg-[#4b5563] px-4 py-2 text-sm font-medium text-white hover:opacity-90">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl dark:bg-gray-dark">
            ...
            <div className="flex flex-wrap gap-1 border-b border-stroke px-4 py-2 text-xs text-gray-400 dark:border-dark-3">
              {["Sans Serif","Normal","B","I","U","S"].map((t,i)=><span key={i} className="rounded px-1.5 py-0.5 hover:bg-gray-100 cursor-pointer">{t}</span>)}
            </div>
            <div className="p-4">
