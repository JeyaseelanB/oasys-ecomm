...
export default function ViewJoiningChecklistPage() {
  ...
  const notes = [
    {
      content: "Kindly approve the joining checklist",
      cards: [
        { title: "Final Approved By", name: "252 / SANKARANARAYANAN C", designation: "SUPERINTENDENT", date: "13-03-2026" },
      ],
    },
  ];
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">View Joining Checklist</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            <li><Link href="/" className="font-medium text-dark hover:text-primary dark:text-gray-400">Home</Link></li>
            <li className="text-gray-400">/</li><li className="text-gray-500 dark:text-gray-400">Personnel</li>
            <li className="text-gray-400">/</li><li className="text-gray-500 dark:text-gray-400">Human Resource</li>
            <li className="text-gray-400">/</li><li className="font-medium text-primary">View Joining Checklist</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="rounded-t-[10px] bg-[#2d8f7b] px-5 py-3">
          <h3 className="text-sm font-semibold text-white">View Joining Checklist</h3>
        </div>

        <div className="p-5">
          {/* Details */}
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div><p className="text-xs text-gray-500">Appointment Order No.</p><p className="text-sm font-medium text-[#17a2b8]">APO/HO/2024/001</p></div>
            <div><p className="text-xs text-gray-500">Employee Name</p><p className="text-sm font-medium text-[#17a2b8]">SANKARANARAYANAN</p></div>
            <div><p className="text-xs text-gray-500">Designation</p><p className="text-sm font-medium text-[#17a2b8]">ASSISTANT SALES MAN</p></div>
          </div>

          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div><p className="text-xs text-gray-500">Security Deposit</p><p className="text-sm font-medium text-[#17a2b8]">&#8377; 0.00</p></div>
            <div><p className="text-xs text-gray-500">Mode of Payment</p><p className="text-sm font-medium text-[#17a2b8]">Cash</p></div>
            <div><p className="text-xs text-gray-500">Increment Cycle</p><p className="text-sm font-medium text-[#17a2b8]">2024-2025</p></div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="overflow-x-auto rounded border border-stroke dark:border-dark-3">
              <table className="w-full table-auto">
                <thead>
                  <tr className="text-left text-sm font-semibold text-white" style={{ backgroundColor: "#17a2b8" }}>
                ...
                <tbody>
                  <tr className="border-t border-stroke text-sm dark:border-dark-3">
                    <td className="px-4 py-2.5 text-center text-dark dark:text-white">1</td>
                    <td className="px-4 py-2.5 text-dark dark:text-white">Appointment Order</td>
                    <td className="px-4 py-2.5 text-primary hover:underline cursor-pointer">appointment_order.pdf</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="flex items-center justify-between border-t border-stroke pt-4 dark:border-dark-3">
            ...
            <button onClick={() => router.push("/personnel/human-resource/joining-checklist/list")} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90">
