...
export default function CadrewisePayHeadConfigCreatePage() {
    ...
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          Cadrewise Pay Head Configuration
        </h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Add Cadrewise Pay Head Configuration</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="p-5 space-y-4">
          {/* Row 1: Cadre / Head Code / Percentage Head Code / Percentage */}
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <select value={form.percHeadCode} onChange={e => set("percHeadCode", e.target.value)} className={selectCls}>
                <option value="">-- Select --</option>
                {PERC_HEAD_CODE_OPTIONS.filter(Boolean).map(o => <option key={o} value={o}>{o}</option>)}
              </select>
            </div>
            <div>
          ...
          {/* Row 2: Pay Aspect / Probation Period (radio) / Applicable (radio) / Display Order */}
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div>
