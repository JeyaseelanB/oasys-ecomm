...
export default function CreateCourtCasePage() {
  ...
  const [counterAffidavit, setCounterAffidavit] = useState("No");
  const [vakalathFiled, setVakalathFiled] = useState("No");
  const [dateOfFilingCounter, setDateOfFilingCounter] = useState("");
  const [stageOfCase, setStageOfCase] = useState("");
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Register Court Case</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Register Court Case</li>
          </ol>
        </nav>
      </div>
