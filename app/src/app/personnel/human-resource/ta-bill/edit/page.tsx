...
const BILL_DATA: Record<number, {
  taBillType: string;
  designation: string;
  entityCodeName1: string;
  entityCodeName2: string;
  basicPay: string;
  ...
  1: {
    ...
    entityCodeName1: "10 / HEAD OFFICE",
    entityCodeName2: "",
    basicPay: "43530.00",
    journeyRows: [
      { id: 1, dateFrom: "01-May-2022 / 00:00:00", dateTo: "31-May-2022 / 00:00:00", routeFrom: "chennai", routeTo: "Tirunelveli", purposeOfJourney: "Inspection", modeType: "Train", amount: 1040.0, numberOfKilometers: 350.0, railClass: "Sleeper", railFare: 1040.0, additionalFare: 0.0, noOfDays: 3.0, dailyAllowance: 1500.0, totalAmount: 3580.0, remarks: "" },
    ],
  },
};
...
function EditContent() {
  ...
  const initial = BILL_DATA[id] ?? BILL_DATA[1];

  const [taBillType, setTaBillType] = useState(initial.taBillType);
  const [designation, setDesignation] = useState(initial.designation);
  const [entityCodeName1, setEntityCodeName1] = useState(initial.entityCodeName1);
  const [entityCodeName2, setEntityCodeName2] = useState(initial.entityCodeName2);
  const [journeyRows, setJourneyRows] = useState<JourneyRow[]>(initial.journeyRows);
  ...
  const handleAddJourney = () => {
    ...
    const newRow: JourneyRow = {
      id: Date.now(), dateFrom, dateTo, routeFrom, routeTo, purposeOfJourney,
  ...
  const totals = journeyRows.reduce(
    (acc, r) => ({ amount: acc.amount + r.amount, numberOfKilometers: acc.numberOfKilometers + r.numberOfKilometers, railFare: acc.railFare + r.railFare, additionalFare: acc.additionalFare + r.additionalFare, noOfDays: acc.noOfDays + r.noOfDays, dailyAllowance: acc.dailyAllowance + r.dailyAllowance, totalAmount: acc.totalAmount + r.totalAmount }),
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Edit Travelling Allowance Bill</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Edit Travelling Allowance Bill</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="p-5">
          ...
          <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="flex">
                ...
                <input type="text" value={initial.basicPay} readOnly className="w-full rounded-r border border-stroke bg-gray-50 px-3 py-2 text-sm outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white" />
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <label className="mb-1 block text-xs text-gray-500">&nbsp;</label>
              <div className="flex">
                <IconBox><svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg></IconBox>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-[#2d8f7b] text-white">
                  ...
                  <th rowSpan={2} className="border border-[#3aa88f] px-2 py-2 text-center font-semibold align-middle">No. of KM</th>
                  <th colSpan={3} className="border border-[#3aa88f] px-2 py-2 text-center font-semibold">Additional Rail Fare</th>
                  <th colSpan={2} className="border border-[#3aa88f] px-2 py-2 text-center font-semibold">Daily Allowance</th>
                  <th rowSpan={2} className="border border-[#3aa88f] px-2 py-2 text-center font-semibold align-middle">Total (₹)</th>
                ...
                <tr className="bg-[#2d8f7b] text-white">
                  ...
                  <th className="border border-[#3aa88f] px-2 py-2 text-center font-semibold">Add. Fare</th>
                  <th className="border border-[#3aa88f] px-2 py-2 text-center font-semibold">Days</th>
                  <th className="border border-[#3aa88f] px-2 py-2 text-center font-semibold">Amount</th>
                </tr>
              </thead>
              <tbody>
...
export default function EditTABillPage() {
  return (
