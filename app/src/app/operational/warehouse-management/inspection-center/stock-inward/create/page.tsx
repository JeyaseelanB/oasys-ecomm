...
export default function CreateStockInwardICPage() {
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="p-5">
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-dark dark:text-white">Stock Inward From</label>
              <div className="flex">
                ...
                <select value={stockInwardFrom} onChange={(e) => setStockInwardFrom(e.target.value)} className="w-full rounded-r border border-stroke bg-transparent px-3 py-2 text-sm outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white">
                  <option value="">Select</option>
            ...
            <div>
              ...
              <div className="flex">
                ...
                <select value={stockOutwardNumberDate} onChange={(e) => setStockOutwardNumberDate(e.target.value)} className="w-full rounded-r border border-stroke bg-transparent px-3 py-2 text-sm outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white">
                  <option value="">Select</option>
                  <option value="2026-370050 / 08-Mar-2026">2026-370050 / 08-Mar-2026</option>
                  <option value="2026-370045 / 07-Mar-2026">2026-370045 / 07-Mar-2026</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 flex items-center justify-end gap-3">
            <button onClick={() => { setType(""); setStockInwardFrom(""); setStockOutwardNumberDate(""); setProducts([]); }} className="flex items-center gap-1.5 rounded bg-[#6c757d] px-4 py-2 text-sm font-medium text-white hover:opacity-90">
          ...
          <div className="mt-5 mb-2 flex items-center gap-2">
            ...
            <h4 className="text-sm font-semibold text-dark dark:text-white">Receive Product</h4>
          </div>
            ...
            <div>
              ...
              <div className="flex">
                ...
                <select value={bundleNumber} onChange={(e) => setBundleNumber(e.target.value)} className="w-48 rounded-r border border-stroke bg-transparent px-3 py-2 text-sm outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white">
                  ...
                  <option value="BDL-002">BDL-002</option>
                </select>
              </div>
            </div>
            <div>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-[#2d8f7b] text-white">
                  ...
                  <th className="border border-[#3aa88f] px-2 py-2.5 text-center align-middle font-semibold">Received Unit</th>
                ...
                {products.length === 0 ? (
                  ...
                  products.map((item, idx) => (
                    <tr key={item.id} className={idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"}>
                      ...
                      <td className="border border-stroke px-2 py-2 text-right align-middle text-dark dark:border-dark-3 dark:text-white">{item.receivedUnit.toFixed(2)}</td>
          ...
          <div className="flex items-center justify-end gap-3 border-t border-stroke pt-4 dark:border-dark-3">
            <button onClick={() => router.push("/operational/warehouse-management/inspection-center/stock-inward/list")} className="flex items-center gap-1.5 rounded bg-[#dc3545] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90">
