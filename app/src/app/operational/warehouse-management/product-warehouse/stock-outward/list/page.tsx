...
const SAMPLE_DATA: StockOutwardItem[] = [
  { id: 1, stockOutwardNo: "2026-362484", stockMovementType: "Warehouse", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1185/DWH - COIMBATORE", stockSentDate: "04-Mar-2026", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 2, stockOutwardNo: "2024-360611", stockMovementType: "Warehouse", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "2085/DWH-TIRUNELVELI", stockSentDate: "08-Mar-2024", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
  { id: 3, stockOutwardNo: "2024-360607", stockMovementType: "Warehouse", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "2185/DWH-VELLORE", stockSentDate: "08-Mar-2024", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 4, stockOutwardNo: "2024-360606", stockMovementType: "Showroom", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1827/THANGAM PATTU MALIGAI", stockSentDate: "08-Mar-2024", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
  { id: 5, stockOutwardNo: "2024-360605", stockMovementType: "Showroom", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1242/NAGAPATTINAM", stockSentDate: "08-Mar-2024", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 6, stockOutwardNo: "2024-360465", stockMovementType: "ISSR", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1676/ISSR - CHENNAI", stockSentDate: "07-Mar-2024", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 7, stockOutwardNo: "2024-360461", stockMovementType: "Warehouse", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1985/DWH - THANJAVUR", stockSentDate: "07-Mar-2024", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
  { id: 8, stockOutwardNo: "2024-360458", stockMovementType: "ISSR", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1976/ISSR - THANJAVUR", stockSentDate: "07-Mar-2024", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 9, stockOutwardNo: "2024-360457", stockMovementType: "Showroom", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1811/ATTUR", stockSentDate: "07-Mar-2024", status: "SUBMITTED", ackStatus: "AWAITING ACKNOWLEDGEMENT" },
  { id: 10, stockOutwardNo: "2024-360456", stockMovementType: "Showroom", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1827/THANGAM PATTU MALIGAI", stockSentDate: "07-Mar-2024", status: "SUBMITTED", ackStatus: "ACKNOWLEDGED" },
];

const STATUS_STYLES: Record<StockStatus, string> = { SUBMITTED: "bg-[#FFA70B] text-white" };
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Stock Outward List - Product Warehouse</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Stock Outward List - Product Warehouse</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">15426</span> - Stock Outward(s)</p>
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/operational/warehouse-management/product-warehouse/stock-outward/acknowledgement-report" className="flex items-center gap-1.5 rounded bg-[#28a745] px-3 py-2 text-xs font-medium text-white hover:opacity-90">
            ...
            <button onClick={() => { if (selectedId) router.push("/operational/warehouse-management/product-warehouse/stock-outward/delivery-challan"); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#6c757d] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
              <svg className="size-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/></svg>
              Delivery Challan
            </button>
            <button onClick={() => { if (selectedId) router.push("/operational/warehouse-management/product-warehouse/stock-outward/pp-delivery-challan"); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#6f42c1] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
              <svg className="size-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/></svg>
              PP Delivery Challan
            </button>
            <Link href="/operational/warehouse-management/product-warehouse/stock-outward/create" className="flex items-center gap-1.5 rounded bg-[#28a745] px-3 py-2 text-xs font-medium text-white hover:opacity-90">
            ...
            <button onClick={() => { if (selectedId) router.push("/operational/warehouse-management/product-warehouse/stock-outward/edit"); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#28a745] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
            ...
            <button onClick={() => { if (selectedId) router.push("/operational/warehouse-management/product-warehouse/stock-outward/view"); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-3 py-2 text-xs font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
