...
type AckStatus = "ACKNOWLEDGED" | "PENDING" | "REJECTED";
...
const SAMPLE_DATA: StockAckItem[] = [
  { id: 1, stockInwardNumber: "2381-MAR26-362483", senderCodeName: "353313/T(H) 110, ARINGNAR ANNA P.W.C.S.LTD.,", receiverCodeName: "2381/PWH CHENNIMALAI", stockReceivedDate: "04-Mar-2026", acknowledgedDate: "05-Mar-2026", status: "ACKNOWLEDGED" },
  { id: 2, stockInwardNumber: "2381-MAR26-362482", senderCodeName: "353313/T(H) 110, ARINGNAR ANNA P.W.C.S.LTD.,", receiverCodeName: "2381/PWH CHENNIMALAI", stockReceivedDate: "03-Mar-2026", acknowledgedDate: "04-Mar-2026", status: "ACKNOWLEDGED" },
  { id: 3, stockInwardNumber: "1181-APR24-361118", senderCodeName: "151443/VADAMBATCHERY SRI RAMALINGA CHOODAMBIGA WCS.,K.905,", receiverCodeName: "1181/PWH - COIMBATORE", stockReceivedDate: "11-Apr-2024", acknowledgedDate: "", status: "PENDING" },
  { id: 4, stockInwardNumber: "1181-APR24-361117", senderCodeName: "151443/VADAMBATCHERY SRI RAMALINGA CHOODAMBIGA WCS.,K.905,", receiverCodeName: "1181/PWH - COIMBATORE", stockReceivedDate: "11-Apr-2024", acknowledgedDate: "12-Apr-2024", status: "ACKNOWLEDGED" },
  { id: 5, stockInwardNumber: "2381-MAR24-360900", senderCodeName: "292774/KALIKKAVALASU INDUSTRIAL W.C.S E.H.131,", receiverCodeName: "1303/DNP Office Erode Garments", stockReceivedDate: "09-Mar-2024", acknowledgedDate: "10-Mar-2024", status: "ACKNOWLEDGED" },
  { id: 6, stockInwardNumber: "2381-MAR24-360899", senderCodeName: "292774/KALIKKAVALASU INDUSTRIAL W.C.S E.H.131,", receiverCodeName: "1303/DNP Office Erode Garments", stockReceivedDate: "09-Mar-2024", acknowledgedDate: "", status: "REJECTED" },
  { id: 7, stockInwardNumber: "2381-MAR24-360893", senderCodeName: "292774/KALIKKAVALASU INDUSTRIAL W.C.S E.H.131,", receiverCodeName: "1106/NMP CFDS CENTRE ERODE", stockReceivedDate: "09-Mar-2024", acknowledgedDate: "10-Mar-2024", status: "ACKNOWLEDGED" },
  { id: 8, stockInwardNumber: "2381-MAR24-360892", senderCodeName: "293572/EH.216,ELUMALAIYAN POWERLOOM WCS.LTD.,", receiverCodeName: "1106/NMP CFDS CENTRE ERODE", stockReceivedDate: "09-Mar-2024", acknowledgedDate: "", status: "PENDING" },
  { id: 9, stockInwardNumber: "2381-FEB24-360500", senderCodeName: "293572/EH.216,ELUMALAIYAN POWERLOOM WCS.LTD.,", receiverCodeName: "1881/PWH - SALEM", stockReceivedDate: "15-Feb-2024", acknowledgedDate: "16-Feb-2024", status: "ACKNOWLEDGED" },
  { id: 10, stockInwardNumber: "2381-FEB24-360499", senderCodeName: "353313/T(H) 110, ARINGNAR ANNA P.W.C.S.LTD.,", receiverCodeName: "1881/PWH - SALEM", stockReceivedDate: "14-Feb-2024", acknowledgedDate: "15-Feb-2024", status: "ACKNOWLEDGED" },
];
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Stock Acknowledgement List</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Stock Acknowledgement List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">6340</span> - Stock Acknowledgement(s)</p>
          <div className="flex flex-wrap items-center gap-2">
            <button className="flex items-center gap-1.5 rounded bg-[#28a745] px-4 py-2 text-sm font-medium text-white hover:opacity-90"><svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="12" y1="11" x2="12" y2="17"/><line x1="9" y1="14" x2="15" y2="14"/></svg> Add</button>
            <button disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"><svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Edit</button>
            <button disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"><svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg> View</button>
            <button disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#dc3545] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"><svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="3,6 5,6 21,6"/><path d="M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v2"/></svg> Delete</button>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th className="cursor-pointer border border-[#3aa88f] px-3 py-3 text-center font-semibold hover:bg-[#267a68]" onClick={() => handleSort("acknowledgedDate")}>Acknowledged Date <SortIcon col="acknowledgedDate" /></th>
              ...
              <tr className="bg-white dark:bg-gray-dark">
                ...
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3"></td>
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3"><select className="w-full rounded border border-stroke bg-transparent px-2 py-1 text-xs text-dark outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" value={filters.status} onChange={(e) => { setFilters((f) => ({ ...f, status: e.target.value })); setCurrentPage(1); }}><option value="">Select</option><option value="ACKNOWLEDGED">ACKNOWLEDGED</option><option value="PENDING">PENDING</option><option value="REJECTED">REJECTED</option></select></td>
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3"></td>
              </tr>
            </thead>
            <tbody>
              {paginated.length === 0 ? (<tr><td colSpan={8} className="py-8 text-center text-gray-400">No records found</td></tr>) : (
                paginated.map((row, idx) => (
                  <tr key={row.id} className={`border-b border-stroke dark:border-dark-3 ${idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"} hover:bg-blue-50 dark:hover:bg-[#1e2d42]`}>
                    ...
                    <td className="border-r border-stroke px-3 py-3 text-center text-dark dark:border-dark-3 dark:text-white">{row.acknowledgedDate || "-"}</td>
