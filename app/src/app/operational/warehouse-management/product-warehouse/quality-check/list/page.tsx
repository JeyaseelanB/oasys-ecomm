...
const SAMPLE_DATA: QualityCheckItem[] = [
  { id: 1, stockInwardNumber: "2381-MAR26-362483", senderCodeName: "353313/T(H) 110, ARINGNAR ANNA P.W.C.S.LTD.,", receiverCodeName: "2381/PWH CHENNIMALAI", stockReceivedDate: "04-Mar-2026", status: "QC COMPLETE" },
  { id: 2, stockInwardNumber: "2381-MAR26-362482", senderCodeName: "353313/T(H) 110, ARINGNAR ANNA P.W.C.S.LTD.,", receiverCodeName: "2381/PWH CHENNIMALAI", stockReceivedDate: "03-Mar-2026", status: "QC COMPLETE" },
  { id: 3, stockInwardNumber: "353313-2015-000176-CBMG-data", senderCodeName: "353313/T(H) 110, ARINGNAR ANNA P.W.C.S.LTD.,", receiverCodeName: "2381/PWH CHENNIMALAI", stockReceivedDate: "27-Sep-2015", status: "QC COMPLETE" },
  { id: 4, stockInwardNumber: "1181-APR24-361118", senderCodeName: "151443/VADAMBATCHERY SRI RAMALINGA CHOODAMBIGA WCS.,K.905,", receiverCodeName: "1181/PWH - COIMBATORE", stockReceivedDate: "11-Apr-2024", status: "QC COMPLETE" },
  { id: 5, stockInwardNumber: "1181-APR24-361117", senderCodeName: "151443/VADAMBATCHERY SRI RAMALINGA CHOODAMBIGA WCS.,K.905,", receiverCodeName: "1181/PWH - COIMBATORE", stockReceivedDate: "11-Apr-2024", status: "QC COMPLETE" },
  { id: 6, stockInwardNumber: "2381-MAR24-360900", senderCodeName: "292774/KALIKKAVALASU INDUSTRIAL W.C.S E.H.131,", receiverCodeName: "1303/DNP Office Erode Garments", stockReceivedDate: "09-Mar-2024", status: "QC COMPLETE" },
  { id: 7, stockInwardNumber: "2381-MAR24-360899", senderCodeName: "292774/KALIKKAVALASU INDUSTRIAL W.C.S E.H.131,", receiverCodeName: "1303/DNP Office Erode Garments", stockReceivedDate: "09-Mar-2024", status: "QC COMPLETE" },
  { id: 8, stockInwardNumber: "2381-MAR24-360893", senderCodeName: "292774/KALIKKAVALASU INDUSTRIAL W.C.S E.H.131,", receiverCodeName: "1106/NMP CFDS CENTRE ERODE", stockReceivedDate: "09-Mar-2024", status: "QC COMPLETE" },
  { id: 9, stockInwardNumber: "2381-MAR24-360892", senderCodeName: "293572/EH.216,ELUMALAIYAN POWERLOOM WCS.LTD.,", receiverCodeName: "1106/NMP CFDS CENTRE ERODE", stockReceivedDate: "09-Mar-2024", status: "QC COMPLETE" },
  { id: 10, stockInwardNumber: "2381-MAR24-360891", senderCodeName: "293572/EH.216,ELUMALAIYAN POWERLOOM WCS.LTD.,", receiverCodeName: "1106/NMP CFDS CENTRE ERODE", stockReceivedDate: "09-Mar-2024", status: "QC COMPLETE" },
];
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Quality Check List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">89007</span> - Quality Check(s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            <Link
              href="/operational/warehouse-management/product-warehouse/quality-check/create"
            ...
            <button
              onClick={() => {
                if (selectedId !== null) {
                  router.push("/operational/warehouse-management/product-warehouse/quality-check/view");
                }
              }}
              disabled={selectedId === null}
              className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              disabled={selectedId === null}
              className="flex items-center gap-1.5 rounded bg-[#dc3545] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th className="cursor-pointer border border-[#3aa88f] px-3 py-3 text-center font-semibold hover:bg-[#267a68]" onClick={() => handleSort("stockReceivedDate")}>
                  Stock Received Date - From <SortIcon col="stockReceivedDate" />
                </th>
              ...
              <tr className="bg-white dark:bg-gray-dark">
                ...
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3">
                  <div className="flex items-center gap-1">
                    ...
                    <svg className="size-4 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>
                  </div>
                </td>
                <td className="border border-stroke px-2 py-1.5 dark:border-dark-3">
                ...
                paginated.map((row, idx) => (
                  <tr key={row.id} className={`border-b border-stroke dark:border-dark-3 ${idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"} hover:bg-blue-50 dark:hover:bg-[#1e2d42]`}>
                    ...
                    <td className="border-r border-stroke px-3 py-3 text-center dark:border-dark-3">
                      <span className={`inline-block rounded-sm px-3 py-1 text-xs font-semibold ${STATUS_STYLES[row.status]}`}>{row.status}</span>
                    </td>
