...
/* ─────────────────────────── Sample Data ─────────────────────────── */
const viewData = {
  stockOutwardNumber: "2024-359624",
  stockMovementType: "",
  distributionWarehouse: "1176 / ISSR - COIMBATORE",
};

const productVarieties: ProductVariety[] = [
  { id: 1, productVarietyCodeName: "YPF1 / PC/POLYSITER SHIRTING CLOTH", uom: "METR", dispatchedQuantity: 576.00, availableQuantity: 114.80, value: 32256.00 },
  { id: 2, productVarietyCodeName: "YPF1 / PC/POLYSITER SHIRTING CLOTH", uom: "METR", dispatchedQuantity: 17.90, availableQuantity: 0.00, value: 1074.00 },
  { id: 3, productVarietyCodeName: "YPF1 / PC/POLYSITER SHIRTING CLOTH", uom: "METR", dispatchedQuantity: 274.50, availableQuantity: 185.90, value: 17842.50 },
];

const totals = {
  dispatchedQuantity: 868.40,
  availableQuantity: 300.70,
  value: 51172.50,
};
...
const PRODUCT_INWARD_DATA: Record<number, ProductInwardDetails> = {
  1: {
    productCodeName: "YPF1 / PC/POLYSITER SHIRTING CLOTH",
    uom: "METR",
    items: [
      { id: 1, bundleNumber: "1", qrCode: "PR1381H11786YPF161", atNumber: "PR1381H1178661", quantity: 576.0, value: 32256.00 },
    ],
    dispatchedQuantity: 576.00,
    receivedValue: 32256.00,
  },
  2: {
    productCodeName: "YPF1 / PC/POLYSITER SHIRTING CLOTH",
    uom: "METR",
    items: [
      { id: 1, bundleNumber: "1", qrCode: "PR1381H11786YPF162", atNumber: "PR1381H1178662", quantity: 17.9, value: 1074.00 },
    ],
    dispatchedQuantity: 17.90,
    receivedValue: 1074.00,
  },
  3: {
    productCodeName: "YPF1 / PC/POLYSITER SHIRTING CLOTH",
    uom: "METR",
    items: [
      { id: 1, bundleNumber: "1", qrCode: "PR1381H11786YPF163", atNumber: "PR1381H1178663", quantity: 274.5, value: 17842.50 },
    ],
    dispatchedQuantity: 274.50,
    receivedValue: 17842.50,
  },
};
...
/* ═══════════════════════════════════════════════════════════════
   PAGE
═══════════════════════════════════════════════════════════════ */
export default function ViewPrintingWarehouseStockOutwardPage() {
    ...
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          View Stock Outward - Printing Warehouse
        </h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">View Stock Outward - Printing Warehouse</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="mb-6 rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        >
          <span className="text-sm font-semibold text-white">View Stock Outward - Printing Warehouse</span>
          <svg
            ...
            <table className="w-full border-collapse text-sm">
              ...
              <tbody>
                ...
                <tr className="bg-gray-50 font-semibold dark:bg-[#1a2232]">
                  ...
                  <td className="border border-stroke px-3 py-2.5 text-right text-[#17a2b8] dark:border-dark-3">{totals.availableQuantity.toFixed(2)}</td>
                  <td className="border border-stroke px-3 py-2.5 text-right text-[#17a2b8] dark:border-dark-3">{totals.value.toFixed(2)}</td>
                </tr>
              </tbody>
            </table>
          </div>
