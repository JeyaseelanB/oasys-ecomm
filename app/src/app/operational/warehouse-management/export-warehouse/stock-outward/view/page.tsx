...
/* ─────────────────────────── Sample Data ─────────────────────────── */
const viewData = {
  stockOutwardNumber: "2023-324984",
  stockMovementType: "",
  distributionWarehouse: "1650 / TVPM-EGMORE",
};

const productVarieties: ProductVariety[] = [
  { id: 1, productVarietyCodeName: "OSP1 / DUPPATTA SALEM", uom: "NOS", dispatchedQuantity: 8.0, availableQuantity: 14.0, value: 14040.0 },
];

const totals = {
  dispatchedQuantity: 8.0,
...
const transportDetails = {
  ...
  transportServiceName: "Door Delivery",
  waybillAvailable: "No",
  waybillNumber: "",
...
const PRODUCT_INWARD_DATA: Record<number, ProductInwardDetails> = {
  1: {
    productCodeName: "SCLB / SOFT SILK SAREE WITH BLOUSE",
    uom: "NOS",
    items: [
      { id: 1, bundleNumber: "2", qrCode: "1181413872", atNumber: "14498", quantity: 1.0, value: 9010.0 },
    ],
    dispatchedQuantity: 1.0,
    receivedValue: 9010.0,
  },
};
...
/* ═══════════════════════════════════════════════════════════════
   PAGE
═══════════════════════════════════════════════════════════════ */
export default function ViewExportWarehouseStockOutwardPage() {
    ...
    <div className="mx-auto">
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">
          View Stock Outward - Export Warehouse
        </h2>
        <nav>
          <ol className="flex flex-wrap items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">View Stock Outward - Export Warehouse</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="mb-6 rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        >
          <span className="text-sm font-semibold text-white">View Stock Outward - Export Warehouse</span>
          <svg
