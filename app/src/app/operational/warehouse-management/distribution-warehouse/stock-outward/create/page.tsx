...
export default function DWCreateStockOutwardPage() {
  ...
  const handleAdd = () => {
    if (bundleNumber.trim() || qrCode.trim()) {
      setProducts([
        { id: 1, productVarietyCodeName: "ASWS / ANGAVAS SALEM WOVEN SILK PURE...", uom: "NOS", dispatchedQuantity: 50.00, value: 425500.00 },
      ]);
    }
  };
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Create Stock Outward - Distribution Warehouse</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Create Stock Outward</li>
          </ol>
        </nav>
      </div>
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <div className="flex">
                ...
                <input type="text" value={entityCodeName} onChange={(e) => setEntityCodeName(e.target.value)} className="w-full rounded-r border border-stroke bg-transparent px-3 py-2 text-sm outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
              </div>
            </div>
          </div>
