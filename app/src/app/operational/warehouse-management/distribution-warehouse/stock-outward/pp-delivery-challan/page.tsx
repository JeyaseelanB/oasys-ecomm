...
const PP_PRODUCTS: PPChallanProduct[] = [
  ...
  { id: 2, sNo: 2, productVarietyCodeName: "BJR4/BEDSHEET", hsnCode: "63041990", uom: "NOS", qty: 1, ppRate: 800.00, ppValue: 800.00, cgstPct: 2.5, cgstValue: 20.00, sgstPct: 2.5, sgstValue: 20.00, totalValue: 840.00 },
  { id: 3, sNo: 3, productVarietyCodeName: "PCOT/COTTON SAREE", hsnCode: "52091100", uom: "NOS", qty: 2, ppRate: 2200.00, ppValue: 4400.00, cgstPct: 2.5, cgstValue: 110.00, sgstPct: 2.5, sgstValue: 110.00, totalValue: 4620.00 },
];
...
const HSN_SUMMARY: HSNSummary[] = [
  ...
  { hsnCode: "63041990", description: "BEDSPREADS", qty: 1, taxableValue: 800.00, cgstPct: 2.5, cgstValue: 20.00, sgstPct: 2.5, sgstValue: 20.00, totalValue: 840.00 },
  { hsnCode: "52091100", description: "COTTON WOVEN FABRICS", qty: 2, taxableValue: 4400.00, cgstPct: 2.5, cgstValue: 110.00, sgstPct: 2.5, sgstValue: 110.00, totalValue: 4620.00 },
];

export default function DWPPDeliveryChallanPage() {
    ...
    <div className="mx-auto">
      ...
      <div className="rounded-[10px] border border-stroke bg-white p-8 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="mb-6 border-b-2 border-dark pb-4 text-center dark:border-gray-500">
          ...
          <h2 className="mt-3 text-lg font-bold text-dark dark:text-white">DELIVERY CHALLAN &amp; ACKNOWLEDGEMENT</h2>
        ...
        <div className="mb-6 grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-1 text-sm text-dark dark:text-white">
              <p><span className="font-semibold">Code:</span> 1242</p>
              <p><span className="font-semibold">Name:</span> NAGAPATTINAM</p>
              <p><span className="font-semibold">Address:</span> 32, NORTH MAIN STREET, NAGAPATTINAM, TAMIL NADU - 611001</p>
              <p><span className="font-semibold">GSTIN:</span> 33AAAAT0212G1ZZ</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 grid grid-cols-3 gap-4 rounded border border-stroke p-3 text-sm dark:border-dark-3">
          <div><span className="font-semibold text-dark dark:text-white">Challan No:</span> <span className="text-dark dark:text-white">PPDC-2026-362490</span></div>
          ...
          <div><span className="font-semibold text-dark dark:text-white">Stock Outward #:</span> <span className="text-dark dark:text-white">2026-362490</span></div>
        </div>
        ...
        <div className="mb-6 rounded border border-stroke p-3 dark:border-dark-3">
          <div className="grid grid-cols-1 gap-2 text-sm text-dark dark:text-white">
            ...
            <p><span className="font-semibold">Amount in Words:</span> Rupees Fifteen Thousand Nine Hundred and Sixty Only</p>
          </div>
        </div>
        ...
        <div className="mb-6 grid grid-cols-2 gap-6">
          <div className="rounded border border-dashed border-gray-400 p-4 text-center">
            <p className="text-xs text-gray-500">Transferor&apos;s Seal</p>
          </div>
          <div className="rounded border border-dashed border-gray-400 p-4 text-center">
            <p className="text-xs text-gray-500">Transferee&apos;s Seal</p>
          </div>
        </div>

        {/* Action Buttons */}
        <div className="flex items-center justify-end gap-3 border-t border-stroke pt-4 dark:border-dark-3">
          <button onClick={() => router.push(`${basePath}/list`)} className="rounded bg-[#6c757d] px-5 py-2.5 text-sm font-medium text-white hover:opacity-90">Cancel</button>
