...
const CHALLAN_PRODUCTS: ChallanProduct[] = [
  ...
  { id: 2, sNo: 2, productVarietyCodeName: "BJR4/BEDSHEET", hsnCode: "63041990", uom: "NOS", qty: 1, rpRate: 1250.00, rpValue: 1250.00 },
  { id: 3, sNo: 3, productVarietyCodeName: "PCOT/COTTON SAREE", hsnCode: "52091100", uom: "NOS", qty: 2, rpRate: 3500.00, rpValue: 7000.00 },
];
...
const HSN_SUMMARY: HSNSummary[] = [
  ...
  { hsnCode: "63041990", description: "BEDSPREADS", qty: 1, value: 1250.00 },
  { hsnCode: "52091100", description: "COTTON WOVEN FABRICS", qty: 2, value: 7000.00 },
];

export default function DWDeliveryChallanPage() {
    ...
    <div className="mx-auto">
      ...
      <div className="rounded-[10px] border border-stroke bg-white p-8 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="mb-6 grid grid-cols-3 gap-4 rounded border border-stroke p-3 text-sm dark:border-dark-3">
          <div><span className="font-semibold text-dark dark:text-white">Challan No:</span> <span className="text-dark dark:text-white">DC-2026-362490</span></div>
        ...
        <div className="mb-6 rounded border border-stroke p-3 dark:border-dark-3">
          <p className="text-sm text-dark dark:text-white"><span className="font-semibold">Amount in Words:</span> Rupees Twenty Five Thousand Two Hundred and Seventy Only</p>
        </div>
