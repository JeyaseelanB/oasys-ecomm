...
const SAMPLE_DATA: StockInwardItem[] = [
  { id: 1, stockInwardNumber: "2024-359342", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "26-Feb-2024", status: "SUBMITTED" },
  { id: 2, stockInwardNumber: "2024-359341", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "26-Feb-2024", status: "SUBMITTED" },
  { id: 3, stockInwardNumber: "2024-359340", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "26-Feb-2024", status: "SUBMITTED" },
  { id: 4, stockInwardNumber: "2024-359339", senderCodeName: "2181/PWH-KANCHIPURAM", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "26-Feb-2024", status: "SUBMITTED" },
  { id: 5, stockInwardNumber: "2024-359337", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "26-Feb-2024", status: "SUBMITTED" },
  { id: 6, stockInwardNumber: "2024-358951", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "22-Feb-2024", status: "SUBMITTED" },
  { id: 7, stockInwardNumber: "2024-358359", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "19-Feb-2024", status: "SUBMITTED" },
  { id: 8, stockInwardNumber: "2024-358011", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "15-Feb-2024", status: "SUBMITTED" },
  { id: 9, stockInwardNumber: "2024-357987", senderCodeName: "1881/PWH - SALEM", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "15-Feb-2024", status: "SUBMITTED" },
  { id: 10, stockInwardNumber: "2024-357831", senderCodeName: "2381/PWH CHENNIMALAI", receiverCodeName: "1785/DWH - MADURAI", stockReceivedDate: "14-Feb-2024", status: "SUBMITTED" },
];
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Stock Inward List - Distribution Warehouse</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Stock Inward List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">2505</span> - Stock Inward List(s)</p>
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/operational/warehouse-management/distribution-warehouse/stock-inward/create" className="flex items-center gap-1.5 rounded bg-[#28a745] px-4 py-2 text-sm font-medium text-white hover:opacity-90">
            ...
            <button onClick={() => { if (selectedId) router.push("/operational/warehouse-management/distribution-warehouse/stock-inward/view"); }} disabled={selectedId === null} className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50">
              <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/></svg>
              View
            </button>
              ...
              {paginated.length === 0 ? (<tr><td colSpan={7} className="py-8 text-center text-gray-400">No records found</td></tr>) : (
                paginated.map((row, idx) => (
                  <tr key={row.id} className={`border-b border-stroke dark:border-dark-3 ${idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"} hover:bg-blue-50 dark:hover:bg-[#1e2d42]`}>
                    ...
                    <td className="border-r border-stroke px-2 py-3 text-center align-middle dark:border-dark-3"><span className="inline-flex items-center justify-center rounded-sm bg-[#FFA70B] px-2 py-0.5 text-xs font-semibold text-white">{row.status}</span></td>
