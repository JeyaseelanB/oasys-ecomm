...
const SAMPLE_DATA: StockInward[] = [
  { id: 1, stockInwardNumber: "1176-DEC19-FDS-1", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "26-Dec-2019", status: "SUBMITTED" },
  { id: 2, stockInwardNumber: "1176-DEC19-FDS-11", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "02-Dec-2019", status: "SUBMITTED" },
  { id: 3, stockInwardNumber: "1176-DEC19-FDS-12", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "16-Dec-2019", status: "SUBMITTED" },
  { id: 4, stockInwardNumber: "1176-OCT19-FDS-1999", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "25-Oct-2019", status: "SUBMITTED" },
  { id: 5, stockInwardNumber: "1176-OCT19-FDS-1998", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "24-Oct-2019", status: "SUBMITTED" },
  { id: 6, stockInwardNumber: "1176-NOV19-FDS-10", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "27-Nov-2019", status: "SUBMITTED" },
  { id: 7, stockInwardNumber: "1176-NOV19-FDS-8", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "11-Nov-2019", status: "SUBMITTED" },
  { id: 8, stockInwardNumber: "1176-OCT19-FDS-2000", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "29-Oct-2019", status: "SUBMITTED" },
  { id: 9, stockInwardNumber: "1176-NOV19-FDS-9", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "15-Nov-2019", status: "SUBMITTED" },
  { id: 10, stockInwardNumber: "1176-SEP19-FDS-2", senderCodeName: "/", receiverCodeName: "1176 / ISSR - COIMBATORE", stockReceivedDate: "30-Sep-2019", status: "SUBMITTED" },
];
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">List Stock Inward - ISSR</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> &nbsp;- List Stock Inward - ISSR(s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/operational/warehouse-management/issr/stock-inward/create">
            ...
            <button
              ...
              onClick={() => {
                if (selectedId !== null) {
                  router.push("/operational/warehouse-management/issr/stock-inward/view");
                }
              }}
