...
const SAMPLE_DATA: StockInwardView = {
  societyCodeName: "/",
  stockMovementNumberFrom: "",
  status: "SUBMITTED",
  stockMovementNumber: "1176-DEC19-FDS-11",
  products: [
    {
      id: 1,
      productVarietyCodeName: "PCDD / CFDS 2020 PL DHOTHY PCDD",
      uom: "NOS",
      dispatchedQty: 0.0,
      receivedUnit: 4840.0,
      value: 96.70,
  ...
  return (
    <div className="mx-auto space-y-5">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">View Stock Inward - ISSR</li>
          </ol>
        </nav>
      </div>

      {/* ══════════════════════════════════════════════════════════
         Section 1: View Stock Inward - ISSR (collapsible header)
      ══════════════════════════════════════════════════════════ */}
      <div className="overflow-hidden rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark">
        ...
        >
          <span className="font-semibold text-white">View Stock Inward - ISSR</span>
      ...
      <div className="flex justify-end pb-4">
        <Link
          href="/operational/warehouse-management/issr/stock-inward/list"
