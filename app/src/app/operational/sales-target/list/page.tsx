...
type SalesTargetStatus = "ACTIVE" | "InActive";
...
const SAMPLE_DATA: SalesTargetItem[] = [
  {
    id: 1,
    fromMonthYear: "2020",
    toMonthYear: "2021",
    regionCodeName: "16 / CHENNAI",
    createdDate: "24-Mar-2021",
    status: "ACTIVE",
  },
];

type SortField = keyof Omit<SalesTargetItem, "id">;
type SortDir = "asc" | "desc";

export default function SalesTargetListPage() {
  ...
  const filtered = SAMPLE_DATA.filter((row) =>
    row.fromMonthYear.toLowerCase().includes(filterFrom.toLowerCase()) &&
    row.toMonthYear.toLowerCase().includes(filterTo.toLowerCase()) &&
    row.regionCodeName.toLowerCase().includes(filterRegion.toLowerCase()) &&
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-500 dark:text-gray-400">Operational Module</li>
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Sales Target List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> -Total Sales Target(s)
          </p>
          <button
            onClick={handleClear}
            ...
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th
                  ...
                  onClick={() => handleSort("fromMonthYear")}
                >
                  From Month - Year <SortIcon field="fromMonthYear" />
                </th>
                <th
                  className="cursor-pointer border border-[#3aa88f] px-3 py-3 text-center font-semibold"
                  onClick={() => handleSort("toMonthYear")}
                >
                  To Month - Year <SortIcon field="toMonthYear" />
                </th>
                <th
                  className="cursor-pointer border border-[#3aa88f] px-3 py-3 text-center font-semibold"
                  onClick={() => handleSort("regionCodeName")}
                >
                  Region Code / Name <SortIcon field="regionCodeName" />
                </th>
                <th
                  className="cursor-pointer border border-[#3aa88f] px-3 py-3 text-center font-semibold"
