...
type PlanStatus = "FINAL_APPROVED" | "PENDING" | "SUBMITTED" | "REJECTED" | "DRAFT";
...
const SAMPLE_DATA: ProductionPlanItem[] = [
  { id: 1, planType: "Contract", planCodeName: "CEP-SEP-2025-379 / test123", planFrom: "01-Sep-2025", planTo: "30-Sep-2025", dueDate: "30-Sep-2025", status: "FINAL_APPROVED" },
  { id: 2, planType: "Contract", planCodeName: "CEP-MAR-2025-378 / test plan", planFrom: "25-Mar-2025", planTo: "31-Mar-2025", dueDate: "31-Mar-2025", status: "FINAL_APPROVED" },
  { id: 3, planType: "Contract", planCodeName: "CEP-FEB-2025-377 / testtttt", planFrom: "25-Feb-2025", planTo: "25-Feb-2025", dueDate: "25-Feb-2025", status: "FINAL_APPROVED" },
  { id: 4, planType: "Contract", planCodeName: "CEP-FEB-2025-376 / karrythh", planFrom: "05-Feb-2025", planTo: "06-Feb-2025", dueDate: "06-Feb-2025", status: "FINAL_APPROVED" },
  { id: 5, planType: "Contract", planCodeName: "CEP-FEB-2025-375 / djeijfn", planFrom: "03-Feb-2025", planTo: "28-Feb-2025", dueDate: "28-Feb-2025", status: "FINAL_APPROVED" },
  { id: 6, planType: "Contract", planCodeName: "CEP-JAN-2025-374 / dfggdc", planFrom: "28-Jan-2025", planTo: "31-Jan-2025", dueDate: "30-Jan-2025", status: "FINAL_APPROVED" },
  { id: 7, planType: "Contract", planCodeName: "CEP-JAN-2025-371 / ghhhghghg", planFrom: "29-Jan-2025", planTo: "31-Jan-2025", dueDate: "30-Jan-2025", status: "FINAL_APPROVED" },
  { id: 8, planType: "Contract", planCodeName: "CEP-JUL-2024-370 / rajiniplan", planFrom: "30-Jul-2024", planTo: "30-Jul-2024", dueDate: "30-Jul-2024", status: "FINAL_APPROVED" },
  { id: 9, planType: "Contract", planCodeName: "CEP-JUL-2024-369 / dineshplan", planFrom: "24-Jul-2024", planTo: "30-Jul-2024", dueDate: "30-Jul-2024", status: "FINAL_APPROVED" },
  { id: 10, planType: "Contract", planCodeName: "CEP-JUL-2024-368 / selva plan", planFrom: "24-Jul-2024", planTo: "30-Jul-2024", dueDate: "30-Jul-2024", status: "FINAL_APPROVED" },
];
...
export default function ProductionPlanListPage() {
  ...
  const [filters, setFilters] = useState({ planType: "", planCodeName: "", planFrom: "", planTo: "", dueDate: "", status: "" });
  ...
  const filtered = SAMPLE_DATA.filter((row) =>
    (filters.planType === "" || row.planType === filters.planType) &&
  ...
  const handleClear = () => { setFilters({ planType: "", planCodeName: "", planFrom: "", planTo: "", dueDate: "", status: "" }); setSelectedId(null); setCurrentPage(1); };
    ...
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Production Plan List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white"><span className="text-primary">{filtered.length}</span> - Contract Production Plan(s)</p>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th className="cursor-pointer border border-[#3aa88f] px-2 py-3 text-center align-middle font-semibold hover:bg-[#267a68]" onClick={() => handleSort("planType")}>Plan Type <SortIcon col="planType" /></th>
              ...
              <tr className="bg-white dark:bg-gray-dark">
                ...
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"><select className="w-full rounded border border-stroke bg-transparent px-1 py-1 text-xs outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" value={filters.planType} onChange={(e) => { setFilters((f) => ({ ...f, planType: e.target.value })); setCurrentPage(1); }}><option value="">Select</option><option value="Contract">Contract</option><option value="Export">Export</option></select></td>
                ...
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"><div className="flex items-center gap-1"><input type="text" placeholder="dd-MMM-yyyy" className="w-full rounded border border-stroke bg-transparent px-2 py-1 text-xs outline-none focus:border-primary dark:border-dark-3 dark:text-white" value={filters.planFrom} onChange={(e) => { setFilters((f) => ({ ...f, planFrom: e.target.value })); setCurrentPage(1); }} /><svg className="size-3.5 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></div></td>
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"><div className="flex items-center gap-1"><input type="text" placeholder="dd-MMM-yyyy" className="w-full rounded border border-stroke bg-transparent px-2 py-1 text-xs outline-none focus:border-primary dark:border-dark-3 dark:text-white" value={filters.planTo} onChange={(e) => { setFilters((f) => ({ ...f, planTo: e.target.value })); setCurrentPage(1); }} /><svg className="size-3.5 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></div></td>
                ...
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"><select className="w-full rounded border border-stroke bg-transparent px-1 py-1 text-xs outline-none focus:border-primary dark:border-dark-3 dark:bg-gray-dark dark:text-white" value={filters.status} onChange={(e) => { setFilters((f) => ({ ...f, status: e.target.value })); setCurrentPage(1); }}><option value="">Select</option><option value="FINAL_APPROVED">FINAL_APPROVED</option><option value="PENDING">PENDING</option><option value="SUBMITTED">SUBMITTED</option><option value="REJECTED">REJECTED</option><option value="DRAFT">DRAFT</option></select></td>
                <td className="border border-stroke px-1 py-1.5 dark:border-dark-3"></td>
              </tr>
            </thead>
            <tbody>
              {paginated.length === 0 ? (<tr><td colSpan={8} className="py-8 text-center text-gray-400">No records found</td></tr>) : (
                paginated.map((row, idx) => (
                  <tr key={row.id} className={`border-b border-stroke dark:border-dark-3 ${idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"} hover:bg-blue-50 dark:hover:bg-[#1e2d42]`}>
                    ...
                    <td className="border-r border-stroke px-2 py-3 text-center align-middle text-dark dark:border-dark-3 dark:text-white">{row.planType}</td>
