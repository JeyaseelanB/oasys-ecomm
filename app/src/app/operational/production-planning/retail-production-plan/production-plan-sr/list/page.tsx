...
const SAMPLE_DATA: PlanRow[] = [
  { id: 1, code: "thiyagu",              name: "thiyagu",              createdDate: "16-Apr-2025", status: "SUBMITTED" },
  { id: 2, code: "2023_2024_ANNUAL_PLAN", name: "2023_2024_ANNUAL_PLAN", createdDate: "06-Apr-2023", status: "SUBMITTED" },
  { id: 3, code: "23-24 yearly plan",    name: "23-24 yearly plan",    createdDate: "11-Apr-2024", status: "SUBMITTED" },
  { id: 4, code: "PLAN 2023-2024",       name: "PLAN 2023-2024",       createdDate: "11-Apr-2024", status: "SUBMITTED" },
  { id: 5, code: "plan24",               name: "plan24",               createdDate: "25-Jan-2023", status: "SUBMITTED" },
  { id: 6, code: "plan-ch1",             name: "plan-ch1",             createdDate: "11-Apr-2024", status: "INITIATED" },
  { id: 7, code: "plan-ch",              name: "plan-ch",              createdDate: "11-Apr-2024", status: "SUBMITTED" },
];
...
export default function ProductionPlanSRListPage() {
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Production Plan SR List</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li><li className="font-medium text-primary">Production Plan SR List</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="p-4">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            <span className="text-sm font-medium text-dark dark:text-white">
              {filtered.length} - Production Plan SR(s)
            </span>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-[#2d8f7b] text-white">
                  ...
                  <th className="border border-[#3aa88f] px-3 py-2 text-center font-semibold cursor-pointer" onClick={() => toggleSort("code")}>plan Code <SortIcon k="code" /></th>
                  <th className="border border-[#3aa88f] px-3 py-2 text-center font-semibold cursor-pointer" onClick={() => toggleSort("name")}>plan Name <SortIcon k="name" /></th>
                  <th className="border border-[#3aa88f] px-3 py-2 text-center font-semibold cursor-pointer" onClick={() => toggleSort("createdDate")}>Created Date <SortIcon k="createdDate" /></th>
                  <th className="border border-[#3aa88f] px-3 py-2 text-center font-semibold cursor-pointer" onClick={() => toggleSort("status")}>Status <SortIcon k="status" /></th>
              ...
              <tbody>
                {paged.length === 0 ? (
                  <tr><td colSpan={6} className="border border-stroke px-3 py-4 text-left text-sm text-gray-400 dark:border-dark-3">No records found</td></tr>
                ) : (
                  paged.map((row, idx) => (
