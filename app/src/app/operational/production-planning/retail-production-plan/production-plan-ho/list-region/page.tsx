...
const SAMPLE_DATA: RegionPlanItem[] = [
  { id: 1, regionCodeName: "01 / CHENNAI",     planCode: "PP-HO-2025-001", planName: "Retail Production Plan Jan 2025",     createdDate: "01-Jan-2025", status: "FINAL_APPROVED" },
  { id: 2, regionCodeName: "10 / MADURAI",     planCode: "PP-HO-2025-001", planName: "Retail Production Plan Jan 2025",     createdDate: "01-Jan-2025", status: "FINAL_APPROVED" },
  { id: 3, regionCodeName: "20 / COIMBATORE",  planCode: "PP-HO-2025-001", planName: "Retail Production Plan Jan 2025",     createdDate: "01-Jan-2025", status: "FINAL_APPROVED" },
  { id: 4, regionCodeName: "30 / TRICHY",      planCode: "PP-HO-2025-002", planName: "Retail Production Plan Feb 2025",     createdDate: "03-Feb-2025", status: "SUBMITTED"      },
  { id: 5, regionCodeName: "40 / SALEM",       planCode: "PP-HO-2025-002", planName: "Retail Production Plan Feb 2025",     createdDate: "03-Feb-2025", status: "SUBMITTED"      },
  { id: 6, regionCodeName: "55 / ERODE",       planCode: "PP-HO-2025-003", planName: "Pongal Special Production Plan 2025", createdDate: "10-Jan-2025", status: "FINAL_APPROVED" },
  { id: 7, regionCodeName: "01 / CHENNAI",     planCode: "PP-HO-2025-003", planName: "Pongal Special Production Plan 2025", createdDate: "10-Jan-2025", status: "FINAL_APPROVED" },
];
...
type SortKey = keyof RegionPlanItem;
const PAGE_SIZE_OPTIONS = [10, 25, 50, 100];

export default function ProductionPlanHOListRegionPage() {
  const router  = useRouter();
  const basePath = "/operational/production-planning/retail-production-plan/production-plan-ho";

  const [filters, setFilters] = useState({ regionCodeName: "", planCode: "", planName: "", createdDate: "", status: "" });
  ...
  const filtered = SAMPLE_DATA.filter((row) =>
    row.regionCodeName.toLowerCase().includes(filters.regionCodeName.toLowerCase()) &&
  ...
  return (
    <div className="mx-auto">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-[22px] font-bold leading-tight text-dark dark:text-white">Production Plan Region List</h2>
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Production Plan Region List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> - Regions List (s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={() => { setFilters({ regionCodeName: "", planCode: "", planName: "", createdDate: "", status: "" }); setSelectedId(null); setCurrentPage(1); }}
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#2d8f7b] text-white">
                ...
                <th className="cursor-pointer border border-[#3aa88f] px-2 py-3 text-center align-middle font-semibold hover:bg-[#267a68]" onClick={() => handleSort("regionCodeName")}>Region Code / Name <SortIcon col="regionCodeName" /></th>
                <th className="cursor-pointer border border-[#3aa88f] px-2 py-3 text-center align-middle font-semibold hover:bg-[#267a68]" onClick={() => handleSort("planCode")}>plan Code <SortIcon col="planCode" /></th>
              ...
              {paginated.length === 0 ? (
                ...
                paginated.map((row, idx) => (
                  <tr key={row.id} className={`border-b border-stroke dark:border-dark-3 ${idx % 2 === 0 ? "bg-white dark:bg-gray-dark" : "bg-[#f9fafb] dark:bg-[#1a2232]"} hover:bg-blue-50 dark:hover:bg-[#1e2d42]`}>
                    ...
                    <td className="border-r border-stroke px-2 py-3 align-middle font-medium text-[#17a2b8] dark:border-dark-3">{row.regionCodeName}</td>
                    <td className="border-r border-stroke px-2 py-3 align-middle text-dark dark:border-dark-3 dark:text-white">{row.planCode}</td>
