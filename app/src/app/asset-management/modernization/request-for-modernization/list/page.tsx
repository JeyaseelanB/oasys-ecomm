...
type ReqStatus = "SUBMITTED" | "REJECTED" | "FINAL-APPROVED" | "APPROVED" | "PENDING";

interface ModernizationRequestItem {
  id: number;
  hoRo: string;
  entityType: string;
  entity: string;
...
const SAMPLE_DATA: ModernizationRequestItem[] = [
  { id: 1,  hoRo: "MADURAI",  entityType: "Showroom",          entity: "PERIYAKULAM",               nameOfBuilding: "Periyakulam", createdDate: "04-May-2021", status: "REJECTED" },
  { id: 2,  hoRo: "CHENNAI",  entityType: "Collection Office", entity: "Collection Office - Chennai", nameOfBuilding: "Towers",      createdDate: "04-Sep-2018", status: "FINAL-APPROVED" },
  { id: 3,  hoRo: "CHENNAI",  entityType: "Collection Office", entity: "Collection Office - Chennai", nameOfBuilding: "Co_optex",    createdDate: "04-Sep-2018", status: "REJECTED" },
  ...
  { id: 6,  hoRo: "MADURAI",  entityType: "Showroom",          entity: "MADURAI SOUTH",              nameOfBuilding: "South Wing",  createdDate: "15-Jun-2022", status: "SUBMITTED" },
  { id: 7,  hoRo: "CHENNAI",  entityType: "Head Office",       entity: "HEAD OFFICE MAIN",           nameOfBuilding: "HO Tower",    createdDate: "01-Aug-2022", status: "FINAL-APPROVED" },
  { id: 8,  hoRo: "SALEM",    entityType: "Showroom",          entity: "SALEM CENTRAL",              nameOfBuilding: "Central Hall",createdDate: "10-Oct-2022", status: "REJECTED" },
  { id: 9,  hoRo: "ERODE",    entityType: "Collection Office", entity: "ERODE BRANCH",               nameOfBuilding: "Erode Office",createdDate: "05-Nov-2022", status: "APPROVED" },
  { id: 10, hoRo: "VELLORE",  entityType: "Showroom",          entity: "VELLORE MAIN",               nameOfBuilding: "Vellore Showroom", createdDate: "22-Dec-2022", status: "PENDING" },
];

type SortKey = keyof ModernizationRequestItem;
...
export default function RequestForModernizationListPage() {
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
          <ol className="flex items-center gap-1.5 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="font-medium text-primary">Request For Modernization/Construction/Supplementary work List</li>
          </ol>
        </nav>
      </div>
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 py-4 dark:border-dark-3">
          <p className="text-sm font-semibold text-dark dark:text-white">
            <span className="text-primary">{filtered.length}</span> - Request For Modernization/ Construction/Supplementary work(s)
          </p>
          <div className="flex flex-wrap items-center gap-2">
            {/* Add */}
            <Link
              href="/asset-management/modernization/request-for-modernization/create"
            ...
            {/* View */}
            <button
              onClick={() => { if (selectedId) router.push("/asset-management/modernization/request-for-modernization/view"); }}
              disabled={selectedId === null}
              className="flex items-center gap-1.5 rounded bg-[#17a2b8] px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
            >
              <svg className="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
